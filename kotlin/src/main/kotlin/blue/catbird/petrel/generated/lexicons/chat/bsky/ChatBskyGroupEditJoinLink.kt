...
sealed class ChatBskyGroupEditJoinLinkError(val name: String, val description: String?) {
        object InvalidConvo: ChatBskyGroupEditJoinLinkError("InvalidConvo", null)
        object InsufficientRole: ChatBskyGroupEditJoinLinkError("InsufficientRole", null)
        object NoJoinLink: ChatBskyGroupEditJoinLinkError("NoJoinLink", null)
    }
