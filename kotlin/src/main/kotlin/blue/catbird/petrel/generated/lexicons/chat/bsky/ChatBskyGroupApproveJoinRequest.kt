...
sealed class ChatBskyGroupApproveJoinRequestError(val name: String, val description: String?) {
        object InvalidConvo: ChatBskyGroupApproveJoinRequestError("InvalidConvo", null)
        object InsufficientRole: ChatBskyGroupApproveJoinRequestError("InsufficientRole", null)
        object MemberLimitReached: ChatBskyGroupApproveJoinRequestError("MemberLimitReached", null)
    }
