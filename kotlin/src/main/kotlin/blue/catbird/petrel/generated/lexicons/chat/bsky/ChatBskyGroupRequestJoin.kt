...
sealed class ChatBskyGroupRequestJoinError(val name: String, val description: String?) {
        object ConvoLocked: ChatBskyGroupRequestJoinError("ConvoLocked", null)
        object FollowRequired: ChatBskyGroupRequestJoinError("FollowRequired", null)
        object InvalidCode: ChatBskyGroupRequestJoinError("InvalidCode", null)
        object LinkDisabled: ChatBskyGroupRequestJoinError("LinkDisabled", null)
        object MemberLimitReached: ChatBskyGroupRequestJoinError("MemberLimitReached", null)
        object UserKicked: ChatBskyGroupRequestJoinError("UserKicked", null)
    }
