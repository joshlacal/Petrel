...
sealed class ChatBskyGroupCreateGroupError(val name: String, val description: String?) {
        object AccountSuspended: ChatBskyGroupCreateGroupError("AccountSuspended", null)
        object BlockedActor: ChatBskyGroupCreateGroupError("BlockedActor", null)
        object BlockedSubject: ChatBskyGroupCreateGroupError("BlockedSubject", null)
        object NewAccountCannotCreateGroup: ChatBskyGroupCreateGroupError("NewAccountCannotCreateGroup", null)
        object NotFollowedBySender: ChatBskyGroupCreateGroupError("NotFollowedBySender", null)
        object RecipientNotFound: ChatBskyGroupCreateGroupError("RecipientNotFound", null)
        object UserForbidsGroups: ChatBskyGroupCreateGroupError("UserForbidsGroups", null)
    }
