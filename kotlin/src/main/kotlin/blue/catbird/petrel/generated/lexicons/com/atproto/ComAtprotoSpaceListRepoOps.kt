...
sealed class ComAtprotoSpaceListRepoOpsError(val name: String, val description: String?) {
        object SpaceNotFound: ComAtprotoSpaceListRepoOpsError("SpaceNotFound", null)
        object RepoNotFound: ComAtprotoSpaceListRepoOpsError("RepoNotFound", null)
        object RepoTakendown: ComAtprotoSpaceListRepoOpsError("RepoTakendown", null)
        object RepoSuspended: ComAtprotoSpaceListRepoOpsError("RepoSuspended", null)
        object RepoDeactivated: ComAtprotoSpaceListRepoOpsError("RepoDeactivated", null)
    }
