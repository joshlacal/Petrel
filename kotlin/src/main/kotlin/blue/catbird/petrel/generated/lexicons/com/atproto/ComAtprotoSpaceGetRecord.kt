...
sealed class ComAtprotoSpaceGetRecordError(val name: String, val description: String?) {
        object RecordNotFound: ComAtprotoSpaceGetRecordError("RecordNotFound", null)
        object SpaceNotFound: ComAtprotoSpaceGetRecordError("SpaceNotFound", null)
        object RepoNotFound: ComAtprotoSpaceGetRecordError("RepoNotFound", null)
        object RepoTakendown: ComAtprotoSpaceGetRecordError("RepoTakendown", null)
        object RepoSuspended: ComAtprotoSpaceGetRecordError("RepoSuspended", null)
        object RepoDeactivated: ComAtprotoSpaceGetRecordError("RepoDeactivated", null)
    }
