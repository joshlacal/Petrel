...
sealed class AppBskyContactVerifyPhoneError(val name: String, val description: String?) {
        object RateLimitExceeded: AppBskyContactVerifyPhoneError("RateLimitExceeded", null)
        object InvalidDid: AppBskyContactVerifyPhoneError("InvalidDid", null)
        object InvalidPhone: AppBskyContactVerifyPhoneError("InvalidPhone", null)
        object InvalidCode: AppBskyContactVerifyPhoneError("InvalidCode", null)
        object InternalError: AppBskyContactVerifyPhoneError("InternalError", null)
    }
