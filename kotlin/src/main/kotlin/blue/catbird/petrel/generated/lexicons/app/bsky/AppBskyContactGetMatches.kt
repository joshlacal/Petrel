...
sealed class AppBskyContactGetMatchesError(val name: String, val description: String?) {
        object InvalidDid: AppBskyContactGetMatchesError("InvalidDid", null)
        object InvalidLimit: AppBskyContactGetMatchesError("InvalidLimit", null)
        object InvalidCursor: AppBskyContactGetMatchesError("InvalidCursor", null)
        object InternalError: AppBskyContactGetMatchesError("InternalError", null)
    }
