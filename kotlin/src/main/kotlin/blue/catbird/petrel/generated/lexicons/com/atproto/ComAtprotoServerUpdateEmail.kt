...
sealed class ComAtprotoServerUpdateEmailError(val name: String, val description: String?) {
        object ExpiredToken: ComAtprotoServerUpdateEmailError("ExpiredToken", null)
        object InvalidToken: ComAtprotoServerUpdateEmailError("InvalidToken", null)
        object TokenRequired: ComAtprotoServerUpdateEmailError("TokenRequired", null)
    }
