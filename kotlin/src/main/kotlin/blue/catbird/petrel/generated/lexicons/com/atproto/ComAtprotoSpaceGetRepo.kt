...
sealed class ComAtprotoSpaceGetRepoError(val name: String, val description: String?) {
        object SpaceNotFound: ComAtprotoSpaceGetRepoError("SpaceNotFound", null)
        object RepoNotFound: ComAtprotoSpaceGetRepoError("RepoNotFound", null)
        object RepoTakendown: ComAtprotoSpaceGetRepoError("RepoTakendown", null)
        object RepoSuspended: ComAtprotoSpaceGetRepoError("RepoSuspended", null)
        object RepoDeactivated: ComAtprotoSpaceGetRepoError("RepoDeactivated", null)
    }
