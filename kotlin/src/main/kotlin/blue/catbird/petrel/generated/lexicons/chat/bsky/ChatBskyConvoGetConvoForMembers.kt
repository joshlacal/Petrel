...
sealed class ChatBskyConvoGetConvoForMembersError(val name: String, val description: String?) {
        object AccountSuspended: ChatBskyConvoGetConvoForMembersError("AccountSuspended", null)
        object BlockedActor: ChatBskyConvoGetConvoForMembersError("BlockedActor", null)
        object BlockedSubject: ChatBskyConvoGetConvoForMembersError("BlockedSubject", null)
        object MessagesDisabled: ChatBskyConvoGetConvoForMembersError("MessagesDisabled", null)
        object NotFollowedBySender: ChatBskyConvoGetConvoForMembersError("NotFollowedBySender", null)
        object RecipientNotFound: ChatBskyConvoGetConvoForMembersError("RecipientNotFound", null)
    }
