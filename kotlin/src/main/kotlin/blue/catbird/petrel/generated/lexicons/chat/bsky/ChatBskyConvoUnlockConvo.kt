...
sealed class ChatBskyConvoUnlockConvoError(val name: String, val description: String?) {
        object InvalidConvo: ChatBskyConvoUnlockConvoError("InvalidConvo", null)
        object InsufficientRole: ChatBskyConvoUnlockConvoError("InsufficientRole", null)
        object ConvoLockedByModeration: ChatBskyConvoUnlockConvoError("ConvoLockedByModeration", null)
    }
