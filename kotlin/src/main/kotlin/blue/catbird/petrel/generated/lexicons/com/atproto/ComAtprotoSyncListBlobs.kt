...
sealed class ComAtprotoSyncListBlobsError(val name: String, val description: String?) {
        object RepoNotFound: ComAtprotoSyncListBlobsError("RepoNotFound", null)
        object RepoTakendown: ComAtprotoSyncListBlobsError("RepoTakendown", null)
        object RepoSuspended: ComAtprotoSyncListBlobsError("RepoSuspended", null)
        object RepoDeactivated: ComAtprotoSyncListBlobsError("RepoDeactivated", null)
    }
