...
sealed class ChatBskyGroupCreateJoinLinkError(val name: String, val description: String?) {
        object EnabledJoinLinkAlreadyExists: ChatBskyGroupCreateJoinLinkError("EnabledJoinLinkAlreadyExists", null)
        object InvalidConvo: ChatBskyGroupCreateJoinLinkError("InvalidConvo", null)
        object InsufficientRole: ChatBskyGroupCreateJoinLinkError("InsufficientRole", null)
    }
