...
sealed class ComAtprotoServerCreateAccountError(val name: String, val description: String?) {
        object InvalidHandle: ComAtprotoServerCreateAccountError("InvalidHandle", null)
        object InvalidPassword: ComAtprotoServerCreateAccountError("InvalidPassword", null)
        object InvalidInviteCode: ComAtprotoServerCreateAccountError("InvalidInviteCode", null)
        object HandleNotAvailable: ComAtprotoServerCreateAccountError("HandleNotAvailable", null)
        object UnsupportedDomain: ComAtprotoServerCreateAccountError("UnsupportedDomain", null)
        object UnresolvableDid: ComAtprotoServerCreateAccountError("UnresolvableDid", null)
        object IncompatibleDidDoc: ComAtprotoServerCreateAccountError("IncompatibleDidDoc", null)
    }
