...
sealed class ComAtprotoSpaceGetBlobError(val name: String, val description: String?) {
        object BlobNotFound: ComAtprotoSpaceGetBlobError("BlobNotFound", null)
        object SpaceNotFound: ComAtprotoSpaceGetBlobError("SpaceNotFound", null)
        object RepoNotFound: ComAtprotoSpaceGetBlobError("RepoNotFound", null)
        object RepoTakendown: ComAtprotoSpaceGetBlobError("RepoTakendown", null)
        object RepoSuspended: ComAtprotoSpaceGetBlobError("RepoSuspended", null)
        object RepoDeactivated: ComAtprotoSpaceGetBlobError("RepoDeactivated", null)
    }
