...
sealed class ChatBskyGroupEditGroupError(val name: String, val description: String?) {
        object ConvoLocked: ChatBskyGroupEditGroupError("ConvoLocked", null)
        object InvalidConvo: ChatBskyGroupEditGroupError("InvalidConvo", null)
        object InsufficientRole: ChatBskyGroupEditGroupError("InsufficientRole", null)
    }
