...
sealed class AppBskyContactImportContactsError(val name: String, val description: String?) {
        object InvalidDid: AppBskyContactImportContactsError("InvalidDid", null)
        object InvalidContacts: AppBskyContactImportContactsError("InvalidContacts", null)
        object TooManyContacts: AppBskyContactImportContactsError("TooManyContacts", null)
        object InvalidToken: AppBskyContactImportContactsError("InvalidToken", null)
        object InternalError: AppBskyContactImportContactsError("InternalError", null)
    }
