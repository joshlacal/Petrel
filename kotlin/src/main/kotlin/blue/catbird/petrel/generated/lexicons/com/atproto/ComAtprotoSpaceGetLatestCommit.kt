...
sealed class ComAtprotoSpaceGetLatestCommitError(val name: String, val description: String?) {
        object SpaceNotFound: ComAtprotoSpaceGetLatestCommitError("SpaceNotFound", null)
        object RepoNotFound: ComAtprotoSpaceGetLatestCommitError("RepoNotFound", null)
        object RepoTakendown: ComAtprotoSpaceGetLatestCommitError("RepoTakendown", null)
        object RepoSuspended: ComAtprotoSpaceGetLatestCommitError("RepoSuspended", null)
        object RepoDeactivated: ComAtprotoSpaceGetLatestCommitError("RepoDeactivated", null)
    }
