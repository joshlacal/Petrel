...
sealed class AppBskyUnspeccedInitAgeAssuranceError(val name: String, val description: String?) {
        object InvalidEmail: AppBskyUnspeccedInitAgeAssuranceError("InvalidEmail", null)
        object DidTooLong: AppBskyUnspeccedInitAgeAssuranceError("DidTooLong", null)
        object InvalidInitiation: AppBskyUnspeccedInitAgeAssuranceError("InvalidInitiation", null)
    }
