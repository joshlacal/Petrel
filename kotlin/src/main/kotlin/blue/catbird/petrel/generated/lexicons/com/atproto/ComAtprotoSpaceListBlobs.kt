...
sealed class ComAtprotoSpaceListBlobsError(val name: String, val description: String?) {
        object SpaceNotFound: ComAtprotoSpaceListBlobsError("SpaceNotFound", null)
        object RepoNotFound: ComAtprotoSpaceListBlobsError("RepoNotFound", null)
        object RepoTakendown: ComAtprotoSpaceListBlobsError("RepoTakendown", null)
        object RepoSuspended: ComAtprotoSpaceListBlobsError("RepoSuspended", null)
        object RepoDeactivated: ComAtprotoSpaceListBlobsError("RepoDeactivated", null)
    }
