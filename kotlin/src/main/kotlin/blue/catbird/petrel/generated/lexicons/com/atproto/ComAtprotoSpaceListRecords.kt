...
sealed class ComAtprotoSpaceListRecordsError(val name: String, val description: String?) {
        object SpaceNotFound: ComAtprotoSpaceListRecordsError("SpaceNotFound", null)
        object RepoNotFound: ComAtprotoSpaceListRecordsError("RepoNotFound", null)
        object RepoTakendown: ComAtprotoSpaceListRecordsError("RepoTakendown", null)
        object RepoSuspended: ComAtprotoSpaceListRecordsError("RepoSuspended", null)
        object RepoDeactivated: ComAtprotoSpaceListRecordsError("RepoDeactivated", null)
    }
