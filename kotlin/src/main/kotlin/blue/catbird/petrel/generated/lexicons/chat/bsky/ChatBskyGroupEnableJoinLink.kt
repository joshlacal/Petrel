...
sealed class ChatBskyGroupEnableJoinLinkError(val name: String, val description: String?) {
        object InvalidConvo: ChatBskyGroupEnableJoinLinkError("InvalidConvo", null)
        object InsufficientRole: ChatBskyGroupEnableJoinLinkError("InsufficientRole", null)
        object NoJoinLink: ChatBskyGroupEnableJoinLinkError("NoJoinLink", null)
        object LinkAlreadyEnabled: ChatBskyGroupEnableJoinLinkError("LinkAlreadyEnabled", null)
    }
