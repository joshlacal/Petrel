...
sealed class ChatBskyConvoSendMessageBatchError(val name: String, val description: String?) {
        object ConvoLocked: ChatBskyConvoSendMessageBatchError("ConvoLocked", null)
        object InvalidConvo: ChatBskyConvoSendMessageBatchError("InvalidConvo", null)
        object ReplyTargetNotFound: ChatBskyConvoSendMessageBatchError("ReplyTargetNotFound", null)
    }
