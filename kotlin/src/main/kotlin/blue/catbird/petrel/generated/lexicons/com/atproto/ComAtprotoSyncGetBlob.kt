...
sealed class ComAtprotoSyncGetBlobError(val name: String, val description: String?) {
        object BlobNotFound: ComAtprotoSyncGetBlobError("BlobNotFound", null)
        object RepoNotFound: ComAtprotoSyncGetBlobError("RepoNotFound", null)
        object RepoTakendown: ComAtprotoSyncGetBlobError("RepoTakendown", null)
        object RepoSuspended: ComAtprotoSyncGetBlobError("RepoSuspended", null)
        object RepoDeactivated: ComAtprotoSyncGetBlobError("RepoDeactivated", null)
    }
