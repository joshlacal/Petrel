...
sealed class AppBskyContactStartPhoneVerificationError(val name: String, val description: String?) {
        object RateLimitExceeded: AppBskyContactStartPhoneVerificationError("RateLimitExceeded", null)
        object InvalidDid: AppBskyContactStartPhoneVerificationError("InvalidDid", null)
        object InvalidPhone: AppBskyContactStartPhoneVerificationError("InvalidPhone", null)
        object InternalError: AppBskyContactStartPhoneVerificationError("InternalError", null)
    }
