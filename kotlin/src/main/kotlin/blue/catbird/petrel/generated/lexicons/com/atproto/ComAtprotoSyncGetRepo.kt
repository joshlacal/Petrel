...
sealed class ComAtprotoSyncGetRepoError(val name: String, val description: String?) {
        object RepoNotFound: ComAtprotoSyncGetRepoError("RepoNotFound", null)
        object RepoTakendown: ComAtprotoSyncGetRepoError("RepoTakendown", null)
        object RepoSuspended: ComAtprotoSyncGetRepoError("RepoSuspended", null)
        object RepoDeactivated: ComAtprotoSyncGetRepoError("RepoDeactivated", null)
    }
