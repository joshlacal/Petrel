...
sealed class ChatBskyConvoSendMessageError(val name: String, val description: String?) {
        object ConvoLocked: ChatBskyConvoSendMessageError("ConvoLocked", null)
        object InvalidConvo: ChatBskyConvoSendMessageError("InvalidConvo", null)
        object ReplyTargetNotFound: ChatBskyConvoSendMessageError("ReplyTargetNotFound", null)
    }
