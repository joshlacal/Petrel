...
sealed class ComAtprotoSyncGetBlocksError(val name: String, val description: String?) {
        object BlockNotFound: ComAtprotoSyncGetBlocksError("BlockNotFound", null)
        object RepoNotFound: ComAtprotoSyncGetBlocksError("RepoNotFound", null)
        object RepoTakendown: ComAtprotoSyncGetBlocksError("RepoTakendown", null)
        object RepoSuspended: ComAtprotoSyncGetBlocksError("RepoSuspended", null)
        object RepoDeactivated: ComAtprotoSyncGetBlocksError("RepoDeactivated", null)
    }
