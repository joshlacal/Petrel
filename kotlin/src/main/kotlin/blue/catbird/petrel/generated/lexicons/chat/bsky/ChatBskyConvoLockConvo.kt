...
sealed class ChatBskyConvoLockConvoError(val name: String, val description: String?) {
        object ConvoLocked: ChatBskyConvoLockConvoError("ConvoLocked", null)
        object InvalidConvo: ChatBskyConvoLockConvoError("InvalidConvo", null)
        object InsufficientRole: ChatBskyConvoLockConvoError("InsufficientRole", null)
    }
