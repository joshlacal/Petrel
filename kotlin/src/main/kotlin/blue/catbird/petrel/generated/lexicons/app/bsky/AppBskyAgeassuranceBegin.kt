...
sealed class AppBskyAgeassuranceBeginError(val name: String, val description: String?) {
        object InvalidEmail: AppBskyAgeassuranceBeginError("InvalidEmail", null)
        object DidTooLong: AppBskyAgeassuranceBeginError("DidTooLong", null)
        object InvalidInitiation: AppBskyAgeassuranceBeginError("InvalidInitiation", null)
        object RegionNotSupported: AppBskyAgeassuranceBeginError("RegionNotSupported", null)
    }
