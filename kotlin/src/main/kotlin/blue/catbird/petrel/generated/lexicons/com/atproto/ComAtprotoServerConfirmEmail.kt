...
sealed class ComAtprotoServerConfirmEmailError(val name: String, val description: String?) {
        object AccountNotFound: ComAtprotoServerConfirmEmailError("AccountNotFound", null)
        object ExpiredToken: ComAtprotoServerConfirmEmailError("ExpiredToken", null)
        object InvalidToken: ComAtprotoServerConfirmEmailError("InvalidToken", null)
        object InvalidEmail: ComAtprotoServerConfirmEmailError("InvalidEmail", null)
    }
