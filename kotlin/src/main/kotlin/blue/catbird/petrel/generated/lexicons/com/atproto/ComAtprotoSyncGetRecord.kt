...
sealed class ComAtprotoSyncGetRecordError(val name: String, val description: String?) {
        object RecordNotFound: ComAtprotoSyncGetRecordError("RecordNotFound", null)
        object RepoNotFound: ComAtprotoSyncGetRecordError("RepoNotFound", null)
        object RepoTakendown: ComAtprotoSyncGetRecordError("RepoTakendown", null)
        object RepoSuspended: ComAtprotoSyncGetRecordError("RepoSuspended", null)
        object RepoDeactivated: ComAtprotoSyncGetRecordError("RepoDeactivated", null)
    }
