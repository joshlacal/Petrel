...
sealed class ChatBskyGroupDisableJoinLinkError(val name: String, val description: String?) {
        object InvalidConvo: ChatBskyGroupDisableJoinLinkError("InvalidConvo", null)
        object InsufficientRole: ChatBskyGroupDisableJoinLinkError("InsufficientRole", null)
        object NoJoinLink: ChatBskyGroupDisableJoinLinkError("NoJoinLink", null)
    }
