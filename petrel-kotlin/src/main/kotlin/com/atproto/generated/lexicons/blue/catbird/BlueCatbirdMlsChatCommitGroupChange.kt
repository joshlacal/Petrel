...
sealed class BlueCatbirdMlsChatCommitGroupChangeError(val name: String, val description: String?) {
        ...
        object InvalidRequest: BlueCatbirdMlsChatCommitGroupChangeError("InvalidRequest", "The request is malformed or missing required fields")
        object AuthRequired: BlueCatbirdMlsChatCommitGroupChangeError("AuthRequired", "Authentication is required for this operation")
        object Forbidden: BlueCatbirdMlsChatCommitGroupChangeError("Forbidden", "The caller does not have permission for this operation")
        object Conflict: BlueCatbirdMlsChatCommitGroupChangeError("Conflict", "The operation conflicts with the current group state (e.g., epoch mismatch)")
    }
