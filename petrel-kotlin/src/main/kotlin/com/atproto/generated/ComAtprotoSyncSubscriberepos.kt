...
object ComAtprotoSyncSubscriberepos {
...
// The last known event seq number to backfill from.        @SerialName("cursor")
    ...
    sealed class Error(val name: String, val description: String?) {
        ...
        object Consumertooslow: Error("ConsumerTooSlow", "If the consumer of the stream can not keep up with events, and a backlog gets too large, the server will drop the connection.")
    }
...
/** The stream sequence number of this message. */        @SerialName("seq")
        ...
        val ops: List<Repoop>,        @SerialName("blobs")
        ...
        companion object {
            const val TYPE_IDENTIFIER = "#commit"
        }
    }
...
/** The stream sequence number of this message. */        @SerialName("seq")
        ...
        val time: ATProtocolDate    ) {
        companion object {
            const val TYPE_IDENTIFIER = "#sync"
        }
    }
    ...
    data class Identity(
        ...
        val handle: Handle?    ) {
        companion object {
            const val TYPE_IDENTIFIER = "#identity"
        }
    }
    ...
    data class Account(
        ...
        val status: String?    ) {
        companion object {
            const val TYPE_IDENTIFIER = "#account"
        }
    }
    ...
    data class Repoop(
        ...
        companion object {
            const val TYPE_IDENTIFIER = "#repoop"
        }
    }
...
parameters: ComAtprotoSyncSubscriberepos.Parameters): Flow<ComAtprotoSyncSubscriberepos.Message> = flow {
