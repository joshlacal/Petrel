...
public struct BlueCatbirdMlsGroupInfoRefresh { 

    public static let typeIdentifier = "blue.catbird.mls.groupInfoRefresh"
...
extension ATProtoClient.Blue.Catbird.Mls {
    ...
    public func groupInfoRefresh(
        ...
        input: BlueCatbirdMlsGroupInfoRefresh.Input
        
    ) async throws -> (responseCode: Int, data: BlueCatbirdMlsGroupInfoRefresh.Output?) {
        let endpoint = "blue.catbird.mls.groupInfoRefresh"
        ...
        let serviceDID = await networkService.getServiceDID(for: "blue.catbird.mls.groupInfoRefresh")
        ...
        if (200...299).contains(responseCode) {
            do {
                ...
                let decodedData = try decoder.decode(BlueCatbirdMlsGroupInfoRefresh.Output.self, from: responseData)
                
                return (responseCode, decodedData)
            } catch {
                // Log the decoding error for debugging but still return the response code
                LogManager.logError("Failed to decode successful response for blue.catbird.mls.groupInfoRefresh: \(error)")
