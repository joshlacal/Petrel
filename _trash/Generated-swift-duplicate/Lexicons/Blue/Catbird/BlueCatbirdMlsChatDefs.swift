...
public struct ConvoView: ATProtocolCodable, ATProtocolValue {
        ...
        public init(
            groupId: String, creator: DID, members: [MemberView], epoch: Int, cipherSuite: String, createdAt: ATProtocolDate, lastMessageAt: ATProtocolDate?, metadata: ConvoMetadata?, confirmationTag: Bytes?, resetGeneration: Int?
        ) {
