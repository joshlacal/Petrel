...
public struct AppBskyBookmarkGetBookmarks { 
...
public struct Output: ATProtocolCodable {
        ...
        public init(from decoder: Decoder) throws {
            ...
            self.bookmarks = try container.decode([AppBskyBookmarkDefs.BookmarkView].self, forKey: .bookmarks)
...
extension ATProtoClient.App.Bsky.Bookmark {
    ...
    public func getBookmarks(input: AppBskyBookmarkGetBookmarks.Parameters) async throws -> (responseCode: Int, data: AppBskyBookmarkGetBookmarks.Output?) {
        ...
        let serviceDID = await networkService.getServiceDID(for: "app.bsky.bookmark.getBookmarks")
        ...
        if (200...299).contains(responseCode) {
            do {
                ...
                LogManager.logError("Failed to decode successful response for app.bsky.bookmark.getBookmarks: \(error)")
