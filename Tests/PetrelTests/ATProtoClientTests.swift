...
struct ATProtoClientTests {
    ...
    func testOAuthFlowInitiation() async throws {
        let client = createTestClient()
    ...
    func testOAuthCallbackHandling() async throws {
        let client = createTestClient()
    ...
    func testOAuthCallbackErrors() async throws {
        let client = createTestClient()
    ...
    func testAuthenticatedAPICalls() async throws {
        let client = await createAuthenticatedTestClient()
    ...
    func testUnauthenticatedAPICalls() async throws {
        let client = createTestClient()
    ...
    func testXRPCRequestBuilding() async throws {
        let client = await createAuthenticatedTestClient()
    ...
    func testPOSTRequestsWithBody() async throws {
        let client = await createAuthenticatedTestClient()
    ...
    func testTokenRefreshDuringConcurrentCalls() async throws {
        let client = await createAuthenticatedTestClient()
