...
struct AuthenticationServiceTests {
    ...
    func testOAuthAuthorizationURL() async throws {
        let service = createTestAuthService()
    ...
    func testOAuthStateUniqueness() async throws {
        let service = createTestAuthService()
    ...
    func testPKCECodeChallenge() async throws {
        let service = createTestAuthService()
    ...
    func testAuthorizationCodeExchange() async throws {
        let service = createTestAuthService()
    ...
    func testAuthorizationCodeExchangeInvalidState() async throws {
        let service = createTestAuthService()
    ...
    func testAuthorizationCodeExchangeWithError() async throws {
        let service = createTestAuthService()
    ...
    func testAccessTokenRefresh() async throws {
        let service = createTestAuthService()
    ...
    func testTokenRefreshInvalidRefreshToken() async throws {
        let service = createTestAuthService()
    ...
    func testDPoPKeyManagement() async throws {
        let service = createTestAuthService()
    ...
    func testDPoPKeyPersistence() async throws {
        let service = createTestAuthService()
    ...
    func testTokenExchangeNetworkError() async throws {
        let service = createTestAuthService()
    ...
    func testTokenRefreshServerError() async throws {
        let service = createTestAuthService()
