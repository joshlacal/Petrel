...
struct LogManagerTests {
    ...
    func testSensitiveRequestLogging() throws {
    ...
    func testSensitiveResponseLogging() throws {
        let url = try #require(URL(string: "https://example.com/oauth/token"))
    ...
    func testNonTokenEndpointLogging() throws {
    ...
    func testLargeResponseLogging() throws {
    ...
    func testSensitiveRequestBody() throws {
    ...
    func testSafeRequestBody() throws {
        let url = try #require(URL(string: "https://example.com/api/posts"))
        var request = URLRequest(url: url)
        request.httpMethod = "POST"
