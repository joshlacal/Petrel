...
enum class Labelvalue {
    @SerialName("!hide")
    !HIDE,    @SerialName("!no-promote")
    !NO_PROMOTE,    @SerialName("!warn")
    !WARN,    @SerialName("!no-unauthenticated")
    !NO_UNAUTHENTICATED,    @SerialName("dmca-violation")
    DMCA_VIOLATION,    @SerialName("doxxing")
    DOXXING,    @SerialName("porn")
    PORN,    @SerialName("sexual")
    SEXUAL,    @SerialName("nudity")
    NUDITY,    @SerialName("nsfl")
    NSFL,    @SerialName("gore")
    GORE}

object ComAtprotoLabelDefs {
...
/** The AT Protocol version of the label object. */        @SerialName("ver")
        ...
        val sig: ByteArray?    ) {
        companion object {
            const val TYPE_IDENTIFIER = "#label"
        }
    }
    ...
    data class Selflabels(
        ...
        companion object {
            const val TYPE_IDENTIFIER = "#selflabels"
        }
    }
...
/** The short string name of the value or type of this label. */        @SerialName("val")
        val `val`: String    ) {
        companion object {
            const val TYPE_IDENTIFIER = "#selflabel"
        }
    }
...
/** The value of the label being defined. Must only include lowercase ascii and the '-' character ([a-z-]+). */        @SerialName("identifier")
        ...
        val locales: List<Labelvaluedefinitionstrings>    ) {
        companion object {
            const val TYPE_IDENTIFIER = "#labelvaluedefinition"
        }
    }
...
/** The code of the language these strings are written in. */        @SerialName("lang")
        ...
        companion object {
            const val TYPE_IDENTIFIER = "#labelvaluedefinitionstrings"
        }
    }
