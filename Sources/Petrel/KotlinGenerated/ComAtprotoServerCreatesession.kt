...
object ComAtprotoServerCreatesession {
...
// Handle or other identifier supported by the server for the authenticating user.        @SerialName("identifier")
    ...
    sealed class Error(val name: String, val description: String?) {
        ...
        object Authfactortokenrequired: Error("AuthFactorTokenRequired", "")
    }
...
input: ComAtprotoServerCreatesession.Input): ATProtoResponse<ComAtprotoServerCreatesession.Output> {
