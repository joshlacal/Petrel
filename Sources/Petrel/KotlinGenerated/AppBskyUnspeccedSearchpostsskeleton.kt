...
object AppBskyUnspeccedSearchpostsskeleton {
...
// Search query string; syntax, phrase, boolean, and faceting is unspecified, but Lucene query syntax is recommended.        @SerialName("q")
    ...
    data class Output(
        ...
        val posts: List<AppBskyUnspeccedDefs.Skeletonsearchpost>    )
...
parameters: AppBskyUnspeccedSearchpostsskeleton.Parameters): ATProtoResponse<AppBskyUnspeccedSearchpostsskeleton.Output> {
