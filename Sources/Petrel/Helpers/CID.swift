...
public enum CIDCodec: UInt8, ATProtocolValue {
  ...
  public func toCBORValue() throws -> Any { return self.rawValue }
...
public struct Multihash: ATProtocolValue {
  ...
  public func toCBORValue() throws -> Any { return self.bytes }
...
public struct ATProtoLink: Codable, ATProtocolCodable, Hashable, Equatable, Sendable {
  ...
  public init(cidString: String) throws {
    self.cid = try CID.parse(cidString)
  }
  ...
  public func isEqual(to other: any ATProtocolCodable) -> Bool {
    ...
    return self.cid == otherLink.cid  // Compare contained CIDs
  }
  ...
  public func toCBORValue() throws -> Any {
    return CIDAsLink(cid: self.cid)  // Use the wrapper to signal Tag 42 encoding
  }
}
...
public struct CID: Equatable, Hashable, Codable, CustomStringConvertible, ATProtocolValue {
  ...
  init(bytes cidBytes: Data) throws {
    ...
    self.codec = codec
    self.multihash = Multihash(algorithm: hashAlgorithm, length: hashLength, digest: Data(digest))
...
public class DAGCBOR {
  ...
  private static func convertToCBORItem(_ value: Any) throws -> CBOR {
    ...
    case let link as ATProtoLink:
      ...
      return try convertToCBORItem(try link.toCBORValue())
...
extension DAGCBORDecodable where Self: Decodable {
...
extension Data {
  ...
  public func hexDump() -> String {
    ...
    stride(from: 0, to: count, by: 16).forEach { offset in
