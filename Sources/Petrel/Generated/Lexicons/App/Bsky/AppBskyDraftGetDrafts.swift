...
public enum AppBskyDraftGetDrafts {
    ...
    public struct Output: ATProtocolCodable {
        ...
        public init(from decoder: Decoder) throws {
            ...
            drafts = try container.decode([AppBskyDraftDefs.DraftView].self, forKey: .drafts)
        }
...
public extension ATProtoClient.App.Bsky.Draft {
    ...
    func getDrafts(input: AppBskyDraftGetDrafts.Parameters) async throws -> (responseCode: Int, data: AppBskyDraftGetDrafts.Output?) {
