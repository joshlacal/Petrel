...
extension ATProtoClient.App.Bsky.Graph {
    ...
    public func getListMutes(input: AppBskyGraphGetListMutes.Parameters) async throws -> (responseCode: Int, data: AppBskyGraphGetListMutes.Output?) {
        ...
        let serviceDID = await networkService.getServiceDID(for: "app.bsky.graph.getListMutes")
        ...
        if (200...299).contains(responseCode) {
            do {
                ...
                LogManager.logError("Failed to decode successful response for app.bsky.graph.getListMutes: \(error)")
