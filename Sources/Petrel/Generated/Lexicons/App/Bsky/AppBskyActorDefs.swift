...
public struct ViewerState: ATProtocolCodable, ATProtocolValue {
        ...
        public init(from decoder: Decoder) throws {
            ...
            do {
                self.mutedOnlyReposts = try container.decodeIfPresent(Bool.self, forKey: .mutedOnlyReposts)
            } catch {
                // Forward compatibility: a malformed or unknown-shaped optional field
                // must not fail the whole response.
                LogManager.logWarning("Decoding error for optional property 'mutedOnlyReposts' — degrading to nil: \(error)")
                self.mutedOnlyReposts = nil
            }
            do {
                self.mutedOnlyQuoteposts = try container.decodeIfPresent(Bool.self, forKey: .mutedOnlyQuoteposts)
            } catch {
                // Forward compatibility: a malformed or unknown-shaped optional field
                // must not fail the whole response.
                LogManager.logWarning("Decoding error for optional property 'mutedOnlyQuoteposts' — degrading to nil: \(error)")
                self.mutedOnlyQuoteposts = nil
            }
            do {
...
public struct VerificationView: ATProtocolCodable, ATProtocolValue {
        ...
        public init(from decoder: Decoder) throws {
            ...
            do {
                self.issuerDisplayName = try container.decodeIfPresent(String.self, forKey: .issuerDisplayName)
            } catch {
                // Forward compatibility: a malformed or unknown-shaped optional field
                // must not fail the whole response.
                LogManager.logWarning("Decoding error for optional property 'issuerDisplayName' — degrading to nil: \(error)")
                self.issuerDisplayName = nil
            }
            do {
                self.issuerHandle = try container.decodeIfPresent(Handle.self, forKey: .issuerHandle)
            } catch {
                // Forward compatibility: a malformed or unknown-shaped optional field
                // must not fail the whole response.
                LogManager.logWarning("Decoding error for optional property 'issuerHandle' — degrading to nil: \(error)")
                self.issuerHandle = nil
            }
            do {
...
public struct FeedViewPref: ATProtocolCodable, ATProtocolValue {
        ...
        public init(from decoder: Decoder) throws {
            ...
            do {
                ...
                self.hideRepliesByUnfollowed = nil
            }
            do {
                ...
                self.hideRepliesByLikeCount = nil
            }
            do {
...
public struct BskyAppStatePref: ATProtocolCodable, ATProtocolValue {
        ...
        public init(from decoder: Decoder) throws {
            ...
            do {
                ...
                self.activeProgressGuide = nil
            }
            do {
                self.isBetaUser = try container.decodeIfPresent(Bool.self, forKey: .isBetaUser)
            } catch {
                // Forward compatibility: a malformed or unknown-shaped optional field
                // must not fail the whole response.
