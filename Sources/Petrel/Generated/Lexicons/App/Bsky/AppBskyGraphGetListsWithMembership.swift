...
public enum AppBskyGraphGetListsWithMembership {
...
public extension ATProtoClient.App.Bsky.Graph {
    ...
    func getListsWithMembership(input: AppBskyGraphGetListsWithMembership.Parameters) async throws -> (responseCode: Int, data: AppBskyGraphGetListsWithMembership.Output?) {
        ...
        let serviceDID = await networkService.getServiceDID(for: "app.bsky.graph.getListsWithMembership")
