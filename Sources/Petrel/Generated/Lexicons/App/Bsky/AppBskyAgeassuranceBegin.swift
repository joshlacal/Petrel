...
public enum AppBskyAgeassuranceBegin {
    ...
    public struct Input: ATProtocolCodable {
        ...
        public init(email: String, language: String, countryCode: String, regionCode: String? = nil) {
            self.email = email
...
public extension ATProtoClient.App.Bsky.Ageassurance {
    ...
    func begin(
        ...
        let serviceDID = await networkService.getServiceDID(for: "app.bsky.ageassurance.begin")
