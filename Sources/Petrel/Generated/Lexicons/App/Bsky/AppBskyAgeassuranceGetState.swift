...
public enum AppBskyAgeassuranceGetState {
    ...
    public struct Output: ATProtocolCodable {
        ...
        public init(from decoder: Decoder) throws {
            ...
            state = try container.decode(AppBskyAgeassuranceDefs.State.self, forKey: .state)

            metadata = try container.decode(AppBskyAgeassuranceDefs.StateMetadata.self, forKey: .metadata)
        }
...
public extension ATProtoClient.App.Bsky.Ageassurance {
    ...
    func getState(input: AppBskyAgeassuranceGetState.Parameters) async throws -> (responseCode: Int, data: AppBskyAgeassuranceGetState.Output?) {
