...
public struct AppBskyUnspeccedGetOnboardingSuggestedUsersSkeleton { 
...
extension ATProtoClient.App.Bsky.Unspecced {
    ...
    public func getOnboardingSuggestedUsersSkeleton(input: AppBskyUnspeccedGetOnboardingSuggestedUsersSkeleton.Parameters) async throws -> (responseCode: Int, data: AppBskyUnspeccedGetOnboardingSuggestedUsersSkeleton.Output?) {
