...
public struct Output: ATProtocolCodable {
        ...
        public init(from decoder: Decoder) throws {
            ...
            self.follows = try container.decode([AppBskyActorDefs.ProfileView].self, forKey: .follows)
...
extension ATProtoClient.App.Bsky.Graph {
    ...
    public func getFollows(input: AppBskyGraphGetFollows.Parameters) async throws -> (responseCode: Int, data: AppBskyGraphGetFollows.Output?) {
        ...
        let serviceDID = await networkService.getServiceDID(for: "app.bsky.graph.getFollows")
