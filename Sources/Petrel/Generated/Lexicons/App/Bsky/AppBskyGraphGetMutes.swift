...
extension ATProtoClient.App.Bsky.Graph {
    ...
    public func getMutes(input: AppBskyGraphGetMutes.Parameters) async throws -> (responseCode: Int, data: AppBskyGraphGetMutes.Output?) {
        ...
        let serviceDID = await networkService.getServiceDID(for: "app.bsky.graph.getMutes")
        ...
        if (200...299).contains(responseCode) {
            do {
                ...
                LogManager.logError("Failed to decode successful response for app.bsky.graph.getMutes: \(error)")
