...
public struct AppBskyUnspeccedGetSuggestedOnboardingUsers { 
...
extension ATProtoClient.App.Bsky.Unspecced {
    ...
    public func getSuggestedOnboardingUsers(input: AppBskyUnspeccedGetSuggestedOnboardingUsers.Parameters) async throws -> (responseCode: Int, data: AppBskyUnspeccedGetSuggestedOnboardingUsers.Output?) {
