...
public enum AppBskyUnspeccedGetSuggestedOnboardingUsers {
    public static let typeIdentifier = "app.bsky.unspecced.getSuggestedOnboardingUsers"
...
public extension ATProtoClient.App.Bsky.Unspecced {
    // MARK: - getSuggestedOnboardingUsers
    ...
    func getSuggestedOnboardingUsers(input: AppBskyUnspeccedGetSuggestedOnboardingUsers.Parameters) async throws -> (responseCode: Int, data: AppBskyUnspeccedGetSuggestedOnboardingUsers.Output?) {
        let endpoint = "app.bsky.unspecced.getSuggestedOnboardingUsers"
        ...
        let serviceDID = await networkService.getServiceDID(for: "app.bsky.unspecced.getSuggestedOnboardingUsers")
        ...
        if (200 ... 299).contains(responseCode) {
            ...
            do {
                ...
                let decodedData = try decoder.decode(AppBskyUnspeccedGetSuggestedOnboardingUsers.Output.self, from: responseData)
