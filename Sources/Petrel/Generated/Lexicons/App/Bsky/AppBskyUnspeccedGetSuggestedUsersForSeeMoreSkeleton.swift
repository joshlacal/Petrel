...
public struct AppBskyUnspeccedGetSuggestedUsersForSeeMoreSkeleton { 
...
extension ATProtoClient.App.Bsky.Unspecced {
    ...
    public func getSuggestedUsersForSeeMoreSkeleton(input: AppBskyUnspeccedGetSuggestedUsersForSeeMoreSkeleton.Parameters) async throws -> (responseCode: Int, data: AppBskyUnspeccedGetSuggestedUsersForSeeMoreSkeleton.Output?) {
