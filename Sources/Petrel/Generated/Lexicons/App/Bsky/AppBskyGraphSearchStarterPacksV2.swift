...
public enum AppBskyGraphSearchStarterPacksV2 {
...
public extension ATProtoClient.App.Bsky.Graph {
    ...
    func searchStarterPacksV2(input: AppBskyGraphSearchStarterPacksV2.Parameters) async throws -> (responseCode: Int, data: AppBskyGraphSearchStarterPacksV2.Output?) {
