...
public struct AppBskyGraphSearchStarterPacksV2 { 

    public static let typeIdentifier = "app.bsky.graph.searchStarterPacksV2"    
...
extension ATProtoClient.App.Bsky.Graph {
    ...
    public func searchStarterPacksV2(input: AppBskyGraphSearchStarterPacksV2.Parameters) async throws -> (responseCode: Int, data: AppBskyGraphSearchStarterPacksV2.Output?) {
        let endpoint = "app.bsky.graph.searchStarterPacksV2"
        ...
        let serviceDID = await networkService.getServiceDID(for: "app.bsky.graph.searchStarterPacksV2")
