...
public struct AppBskyUnspeccedGetSuggestedUsersForSeeMore { 
...
extension ATProtoClient.App.Bsky.Unspecced {
    ...
    public func getSuggestedUsersForSeeMore(input: AppBskyUnspeccedGetSuggestedUsersForSeeMore.Parameters) async throws -> (responseCode: Int, data: AppBskyUnspeccedGetSuggestedUsersForSeeMore.Output?) {
