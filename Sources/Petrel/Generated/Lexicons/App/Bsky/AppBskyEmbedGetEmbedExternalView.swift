...
public struct AppBskyEmbedGetEmbedExternalView { 
...
public struct Output: ATProtocolCodable {
        ...
        public init(from decoder: Decoder) throws {
            ...
            do {
                self.view = try container.decodeIfPresent(AppBskyEmbedExternal.View.self, forKey: .view)
            } catch {
            ...
            do {
                self.associatedRecords = try container.decodeIfPresent([ATProtocolValueContainer].self, forKey: .associatedRecords)
            } catch {
                // Forward compatibility: a malformed optional field must not fail the whole response.
                LogManager.logWarning("Decoding error for optional property 'associatedRecords' — degrading to nil: \(error)")
                self.associatedRecords = nil
            }
...
extension ATProtoClient.App.Bsky.Embed {
    ...
    public func getEmbedExternalView(input: AppBskyEmbedGetEmbedExternalView.Parameters) async throws -> (responseCode: Int, data: AppBskyEmbedGetEmbedExternalView.Output?) {
