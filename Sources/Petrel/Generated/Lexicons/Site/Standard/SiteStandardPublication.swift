...
public struct SiteStandardPublication: ATProtocolCodable, ATProtocolValue { 
    ...
    public static let typeIdentifier = "site.standard.publication"
        ...
        public init(from decoder: Decoder) throws {
            ...
            do {
                self.basicTheme = try container.decodeIfPresent(SiteStandardThemeBasic.self, forKey: .basicTheme)
            } catch {
            ...
            do {
                self.icon = try container.decodeIfPresent(Blob.self, forKey: .icon)
            } catch {
                // Forward compatibility: a malformed optional field must not fail the whole record.
            ...
            do {
                self.labels = try container.decodeIfPresent(SiteStandardPublicationLabelsUnion.self, forKey: .labels)
            } catch {
                // Forward compatibility: a malformed optional field must not fail the whole record.
