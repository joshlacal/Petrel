...
public struct SiteStandardDocument: ATProtocolCodable, ATProtocolValue { 
    ...
    public static let typeIdentifier = "site.standard.document"
        ...
        public init(from decoder: Decoder) throws {
            ...
            do {
                self.bskyPostRef = try container.decodeIfPresent(ComAtprotoRepoStrongRef.self, forKey: .bskyPostRef)
            } catch {
                ...
                self.bskyPostRef = nil
            }
            do {
                self.content = try container.decodeIfPresent(SiteStandardDocumentContentUnion.self, forKey: .content)
            } catch {
                // Forward compatibility: a malformed optional field must not fail the whole record.
            ...
            do {
                self.coverImage = try container.decodeIfPresent(Blob.self, forKey: .coverImage)
            } catch {
                // Forward compatibility: a malformed optional field must not fail the whole record.
            ...
            do {
                self.labels = try container.decodeIfPresent(SiteStandardDocumentLabelsUnion.self, forKey: .labels)
            } catch {
                // Forward compatibility: a malformed optional field must not fail the whole record.
            ...
            do {
                self.links = try container.decodeIfPresent(SiteStandardDocumentLinksUnion.self, forKey: .links)
            } catch {
                // Forward compatibility: a malformed optional field must not fail the whole record.
            ...
            self.publishedAt = try container.decode(ATProtocolDate.self, forKey: .publishedAt)
            self.site = try container.decode(URI.self, forKey: .site)
            do {
