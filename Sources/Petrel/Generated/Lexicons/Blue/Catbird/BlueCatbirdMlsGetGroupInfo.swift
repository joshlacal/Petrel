...
public struct BlueCatbirdMlsGetGroupInfo { 
...
extension ATProtoClient.Blue.Catbird.Mls {
    ...
    public func getGroupInfo(input: BlueCatbirdMlsGetGroupInfo.Parameters) async throws -> (responseCode: Int, data: BlueCatbirdMlsGetGroupInfo.Output?) {
