...
extension ATProtoClient.Blue.Catbird.MlsChat {
    ...
    public func updateChatRequestSettings(
        ...
        let serviceDID = await networkService.getServiceDID(for: "blue.catbird.mlsChat.updateChatRequestSettings")
        ...
        if (200...299).contains(responseCode) {
            do {
                ...
                LogManager.logError("Failed to decode successful response for blue.catbird.mlsChat.updateChatRequestSettings: \(error)")
