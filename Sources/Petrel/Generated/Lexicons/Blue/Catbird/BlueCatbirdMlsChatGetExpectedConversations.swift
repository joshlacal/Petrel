...
public enum BlueCatbirdMlsChatGetExpectedConversations {
...
public extension ATProtoClient.Blue.Catbird.MlsChat {
    ...
    func getExpectedConversations(input: BlueCatbirdMlsChatGetExpectedConversations.Parameters) async throws -> (responseCode: Int, data: BlueCatbirdMlsChatGetExpectedConversations.Output?) {
        ...
        let serviceDID = await networkService.getServiceDID(for: "blue.catbird.mlsChat.getExpectedConversations")
        ...
        if (200 ... 299).contains(responseCode) {
            do {
                ...
                LogManager.logError("Failed to decode successful response for blue.catbird.mlsChat.getExpectedConversations: \(error)")
