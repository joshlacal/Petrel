...
public enum BlueCatbirdMlsChatGetCommits {
    ...
    public struct CommitMessage: ATProtocolCodable, ATProtocolValue {
        ...
        public func encode(to encoder: Encoder) throws {
            ...
            try container.encodeIfPresent(commitData, forKey: .commitData)
        ...
        public func isEqual(to other: any ATProtocolValue) -> Bool {
            ...
            if commitData != other.commitData {
                return false
            }
        ...
        public func toCBORValue() throws -> Any {
            ...
            if let value = commitData {
                let commitDataValue = try value.toCBORValue()
...
public extension ATProtoClient.Blue.Catbird.MlsChat {
    ...
    func getCommits(input: BlueCatbirdMlsChatGetCommits.Parameters) async throws -> (responseCode: Int, data: BlueCatbirdMlsChatGetCommits.Output?) {
        ...
        let serviceDID = await networkService.getServiceDID(for: "blue.catbird.mlsChat.getCommits")
        ...
        if (200 ... 299).contains(responseCode) {
            do {
                ...
                LogManager.logError("Failed to decode successful response for blue.catbird.mlsChat.getCommits: \(error)")
