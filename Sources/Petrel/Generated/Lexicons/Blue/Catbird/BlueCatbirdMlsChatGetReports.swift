...
public enum BlueCatbirdMlsChatGetReports {
    ...
    public struct ReportView: ATProtocolCodable, ATProtocolValue {
        ...
        public func isEqual(to other: any ATProtocolValue) -> Bool {
            ...
            if reporterDid != other.reporterDid {
                return false
            }
            if reportedDid != other.reportedDid {
                return false
            }
            if encryptedContent != other.encryptedContent {
                return false
            }
...
public extension ATProtoClient.Blue.Catbird.MlsChat {
    ...
    func getReports(input: BlueCatbirdMlsChatGetReports.Parameters) async throws -> (responseCode: Int, data: BlueCatbirdMlsChatGetReports.Output?) {
        ...
        let serviceDID = await networkService.getServiceDID(for: "blue.catbird.mlsChat.getReports")
        ...
        if (200 ... 299).contains(responseCode) {
            do {
                ...
                LogManager.logError("Failed to decode successful response for blue.catbird.mlsChat.getReports: \(error)")
