...
public enum BlueCatbirdMlsChatWarnMember {
...
public extension ATProtoClient.Blue.Catbird.MlsChat {
    ...
    func warnMember(
        ...
        let serviceDID = await networkService.getServiceDID(for: "blue.catbird.mlsChat.warnMember")
        ...
        if (200 ... 299).contains(responseCode) {
            do {
                ...
                LogManager.logError("Failed to decode successful response for blue.catbird.mlsChat.warnMember: \(error)")
