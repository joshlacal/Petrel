...
extension ATProtoClient.Blue.Catbird.MlsChat {
    ...
    public func getOptInStatus(input: BlueCatbirdMlsChatGetOptInStatus.Parameters) async throws -> (responseCode: Int, data: BlueCatbirdMlsChatGetOptInStatus.Output?) {
        ...
        let serviceDID = await networkService.getServiceDID(for: "blue.catbird.mlsChat.getOptInStatus")
        ...
        if (200...299).contains(responseCode) {
            do {
                ...
                LogManager.logError("Failed to decode successful response for blue.catbird.mlsChat.getOptInStatus: \(error)")
