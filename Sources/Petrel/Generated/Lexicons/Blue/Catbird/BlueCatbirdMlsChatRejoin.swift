...
extension ATProtoClient.Blue.Catbird.MlsChat {
    ...
    public func rejoin(
        ...
        let serviceDID = await networkService.getServiceDID(for: "blue.catbird.mlsChat.rejoin")
        ...
        if (200...299).contains(responseCode) {
            do {
                ...
                LogManager.logError("Failed to decode successful response for blue.catbird.mlsChat.rejoin: \(error)")
