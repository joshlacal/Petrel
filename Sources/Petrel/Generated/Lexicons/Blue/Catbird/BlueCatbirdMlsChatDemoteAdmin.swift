...
extension ATProtoClient.Blue.Catbird.MlsChat {
    ...
    public func demoteAdmin(
        ...
        let endpoint = "blue.catbird.mlsChat.demoteAdmin"
        ...
        let serviceDID = await networkService.getServiceDID(for: "blue.catbird.mlsChat.demoteAdmin")
        ...
        if (200...299).contains(responseCode) {
            do {
                ...
                LogManager.logError("Failed to decode successful response for blue.catbird.mlsChat.demoteAdmin: \(error)")
