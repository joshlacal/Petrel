...
public enum BlueCatbirdMlsChatRevokeInvite {
...
public extension ATProtoClient.Blue.Catbird.MlsChat {
    ...
    func revokeInvite(
        ...
        let serviceDID = await networkService.getServiceDID(for: "blue.catbird.mlsChat.revokeInvite")
        ...
        if (200 ... 299).contains(responseCode) {
            do {
                ...
                LogManager.logError("Failed to decode successful response for blue.catbird.mlsChat.revokeInvite: \(error)")
