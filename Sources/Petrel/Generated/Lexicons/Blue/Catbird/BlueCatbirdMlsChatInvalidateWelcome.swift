...
public enum BlueCatbirdMlsChatInvalidateWelcome {
    ...
    public struct Output: ATProtocolCodable {
        ...
        public init(from decoder: Decoder) throws {
            ...
            welcomeId = try container.decodeIfPresent(String.self, forKey: .welcomeId)
        }
...
public extension ATProtoClient.Blue.Catbird.MlsChat {
    ...
    func invalidateWelcome(
        ...
        let serviceDID = await networkService.getServiceDID(for: "blue.catbird.mlsChat.invalidateWelcome")
        ...
        if (200 ... 299).contains(responseCode) {
            do {
                ...
                LogManager.logError("Failed to decode successful response for blue.catbird.mlsChat.invalidateWelcome: \(error)")
