...
public enum BlueCatbirdMlsValidateDeviceState {
...
public extension ATProtoClient.Blue.Catbird.Mls {
    ...
    func validateDeviceState(input: BlueCatbirdMlsValidateDeviceState.Parameters) async throws -> (responseCode: Int, data: BlueCatbirdMlsValidateDeviceState.Output?) {
