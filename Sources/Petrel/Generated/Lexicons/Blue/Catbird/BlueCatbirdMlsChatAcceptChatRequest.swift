...
public struct Input: ATProtocolCodable {
        ...
        public init(from decoder: Decoder) throws {
            ...
            self.welcomeData = try container.decodeIfPresent(Bytes.self, forKey: .welcomeData)
        }
...
extension ATProtoClient.Blue.Catbird.MlsChat {
    ...
    public func acceptChatRequest(
        ...
        let serviceDID = await networkService.getServiceDID(for: "blue.catbird.mlsChat.acceptChatRequest")
        ...
        if (200...299).contains(responseCode) {
            do {
                ...
                LogManager.logError("Failed to decode successful response for blue.catbird.mlsChat.acceptChatRequest: \(error)")
