...
extension ATProtoClient.Blue.Catbird.MlsChat {
    ...
    public func getKeyPackageHistory(input: BlueCatbirdMlsChatGetKeyPackageHistory.Parameters) async throws -> (responseCode: Int, data: BlueCatbirdMlsChatGetKeyPackageHistory.Output?) {
        ...
        let serviceDID = await networkService.getServiceDID(for: "blue.catbird.mlsChat.getKeyPackageHistory")
        ...
        if (200...299).contains(responseCode) {
            do {
                ...
                LogManager.logError("Failed to decode successful response for blue.catbird.mlsChat.getKeyPackageHistory: \(error)")
