...
public enum BlueCatbirdMlsChatSyncKeyPackages {
...
public extension ATProtoClient.Blue.Catbird.MlsChat {
    ...
    func syncKeyPackages(
        ...
        let serviceDID = await networkService.getServiceDID(for: "blue.catbird.mlsChat.syncKeyPackages")
        ...
        if (200 ... 299).contains(responseCode) {
            do {
                ...
                LogManager.logError("Failed to decode successful response for blue.catbird.mlsChat.syncKeyPackages: \(error)")
