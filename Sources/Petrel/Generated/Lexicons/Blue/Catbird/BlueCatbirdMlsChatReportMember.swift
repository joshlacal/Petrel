...
extension ATProtoClient.Blue.Catbird.MlsChat {
    ...
    public func reportMember(
        ...
        let endpoint = "blue.catbird.mlsChat.reportMember"
        ...
        let serviceDID = await networkService.getServiceDID(for: "blue.catbird.mlsChat.reportMember")
        ...
        if (200...299).contains(responseCode) {
            do {
                ...
                LogManager.logError("Failed to decode successful response for blue.catbird.mlsChat.reportMember: \(error)")
