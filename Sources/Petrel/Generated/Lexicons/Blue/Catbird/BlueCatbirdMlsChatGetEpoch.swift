...
extension ATProtoClient.Blue.Catbird.MlsChat {
    ...
    public func getEpoch(input: BlueCatbirdMlsChatGetEpoch.Parameters) async throws -> (responseCode: Int, data: BlueCatbirdMlsChatGetEpoch.Output?) {
        ...
        let serviceDID = await networkService.getServiceDID(for: "blue.catbird.mlsChat.getEpoch")
        ...
        if (200...299).contains(responseCode) {
            do {
                ...
                LogManager.logError("Failed to decode successful response for blue.catbird.mlsChat.getEpoch: \(error)")
