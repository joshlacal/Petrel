...
extension ATProtoClient.Blue.Catbird.MlsChat {
    ...
    public func getPolicy(input: BlueCatbirdMlsChatGetPolicy.Parameters) async throws -> (responseCode: Int, data: BlueCatbirdMlsChatGetPolicy.Output?) {
        ...
        let serviceDID = await networkService.getServiceDID(for: "blue.catbird.mlsChat.getPolicy")
        ...
        if (200...299).contains(responseCode) {
            do {
                ...
                LogManager.logError("Failed to decode successful response for blue.catbird.mlsChat.getPolicy: \(error)")
