...
public enum BlueCatbirdMlsChatProcessExternalCommit {
    ...
    public struct Input: ATProtocolCodable {
        ...
        public init(from decoder: Decoder) throws {
            ...
            externalCommit = try container.decode(String.self, forKey: .externalCommit)
...
public extension ATProtoClient.Blue.Catbird.MlsChat {
    ...
    func processExternalCommit(
        ...
        let serviceDID = await networkService.getServiceDID(for: "blue.catbird.mlsChat.processExternalCommit")
        ...
        if (200 ... 299).contains(responseCode) {
            do {
                ...
                LogManager.logError("Failed to decode successful response for blue.catbird.mlsChat.processExternalCommit: \(error)")
