...
extension ATProtoClient.Blue.Catbird.Mls {
    ...
    public func demoteModerator(
        ...
        let serviceDID = await networkService.getServiceDID(for: "blue.catbird.mls.demoteModerator")
        ...
        if (200...299).contains(responseCode) {
            do {
                ...
                LogManager.logError("Failed to decode successful response for blue.catbird.mls.demoteModerator: \(error)")
