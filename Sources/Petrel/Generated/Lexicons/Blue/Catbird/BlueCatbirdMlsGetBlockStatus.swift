...
public enum BlueCatbirdMlsGetBlockStatus {
    ...
    public struct Output: ATProtocolCodable {
        ...
        public init(from decoder: Decoder) throws {
            ...
            blocks = try container.decode([BlueCatbirdMlsCheckBlocks.BlockRelationship].self, forKey: .blocks)
...
public extension ATProtoClient.Blue.Catbird.Mls {
    ...
    func getBlockStatus(input: BlueCatbirdMlsGetBlockStatus.Parameters) async throws -> (responseCode: Int, data: BlueCatbirdMlsGetBlockStatus.Output?) {
