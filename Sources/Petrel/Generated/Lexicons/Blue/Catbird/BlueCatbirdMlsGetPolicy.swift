...
public struct BlueCatbirdMlsGetPolicy { 
...
public struct Output: ATProtocolCodable {
        ...
        public init(from decoder: Decoder) throws {
            ...
            self.policy = try container.decode(BlueCatbirdMlsUpdatePolicy.PolicyView.self, forKey: .policy)
...
extension ATProtoClient.Blue.Catbird.Mls {
    ...
    public func getPolicy(input: BlueCatbirdMlsGetPolicy.Parameters) async throws -> (responseCode: Int, data: BlueCatbirdMlsGetPolicy.Output?) {
