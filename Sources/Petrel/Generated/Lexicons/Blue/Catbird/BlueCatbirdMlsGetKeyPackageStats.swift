...
public enum BlueCatbirdMlsGetKeyPackageStats {
...
public extension ATProtoClient.Blue.Catbird.Mls {
    ...
    func getKeyPackageStats(input: BlueCatbirdMlsGetKeyPackageStats.Parameters) async throws -> (responseCode: Int, data: BlueCatbirdMlsGetKeyPackageStats.Output?) {
