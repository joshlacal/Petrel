...
public enum BlueCatbirdMlsChatUpdatePolicy {
...
public extension ATProtoClient.Blue.Catbird.MlsChat {
    ...
    func updatePolicy(
        ...
        let serviceDID = await networkService.getServiceDID(for: "blue.catbird.mlsChat.updatePolicy")
        ...
        if (200 ... 299).contains(responseCode) {
            do {
                ...
                LogManager.logError("Failed to decode successful response for blue.catbird.mlsChat.updatePolicy: \(error)")
