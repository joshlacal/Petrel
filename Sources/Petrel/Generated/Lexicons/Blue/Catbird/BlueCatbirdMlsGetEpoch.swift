...
public enum BlueCatbirdMlsGetEpoch {
...
public extension ATProtoClient.Blue.Catbird.Mls {
    ...
    func getEpoch(input: BlueCatbirdMlsGetEpoch.Parameters) async throws -> (responseCode: Int, data: BlueCatbirdMlsGetEpoch.Output?) {
