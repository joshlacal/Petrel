...
extension ATProtoClient.Blue.Catbird.MlsChat {
    ...
    public func updateGroupInfo(
        ...
        let endpoint = "blue.catbird.mlsChat.updateGroupInfo"
        ...
        let serviceDID = await networkService.getServiceDID(for: "blue.catbird.mlsChat.updateGroupInfo")
        ...
        if (200...299).contains(responseCode) {
            do {
                ...
                LogManager.logError("Failed to decode successful response for blue.catbird.mlsChat.updateGroupInfo: \(error)")
