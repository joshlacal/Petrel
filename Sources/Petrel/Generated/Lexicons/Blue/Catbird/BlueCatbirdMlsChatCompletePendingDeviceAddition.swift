...
extension ATProtoClient.Blue.Catbird.MlsChat {
    ...
    public func completePendingDeviceAddition(
        ...
        let endpoint = "blue.catbird.mlsChat.completePendingDeviceAddition"
        ...
        let serviceDID = await networkService.getServiceDID(for: "blue.catbird.mlsChat.completePendingDeviceAddition")
        ...
        if (200...299).contains(responseCode) {
            do {
                ...
                LogManager.logError("Failed to decode successful response for blue.catbird.mlsChat.completePendingDeviceAddition: \(error)")
