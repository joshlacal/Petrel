...
public enum BlueCatbirdMlsChatDeleteDevice {
...
public extension ATProtoClient.Blue.Catbird.MlsChat {
    ...
    func deleteDevice(
        ...
        let serviceDID = await networkService.getServiceDID(for: "blue.catbird.mlsChat.deleteDevice")
        ...
        if (200 ... 299).contains(responseCode) {
            do {
                ...
                LogManager.logError("Failed to decode successful response for blue.catbird.mlsChat.deleteDevice: \(error)")
