...
public struct PolicyView: ATProtocolCodable, ATProtocolValue {
        ...
        public func isEqual(to other: any ATProtocolValue) -> Bool {
            ...
            if self.allowInvites != other.allowInvites {
                return false
            }
            ...
            if self.adminOnlyInvites != other.adminOnlyInvites {
                return false
            }
            ...
            if self.allowMemberAdd != other.allowMemberAdd {
                return false
            }
            ...
            if self.allowMemberRemove != other.allowMemberRemove {
                return false
            }
            ...
            if self.requireAdminApproval != other.requireAdminApproval {
                return false
            }
            ...
            if self.maxMembers != other.maxMembers {
                return false
            }
