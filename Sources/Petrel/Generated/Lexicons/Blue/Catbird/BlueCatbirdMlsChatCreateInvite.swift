...
public enum BlueCatbirdMlsChatCreateInvite {
...
public extension ATProtoClient.Blue.Catbird.MlsChat {
    ...
    func createInvite(
        ...
        let serviceDID = await networkService.getServiceDID(for: "blue.catbird.mlsChat.createInvite")
        ...
        if (200 ... 299).contains(responseCode) {
            do {
                ...
                LogManager.logError("Failed to decode successful response for blue.catbird.mlsChat.createInvite: \(error)")
