...
public enum BlueCatbirdMlsChatUnregisterDeviceToken {
...
public extension ATProtoClient.Blue.Catbird.MlsChat {
    ...
    func unregisterDeviceToken(
        ...
        let serviceDID = await networkService.getServiceDID(for: "blue.catbird.mlsChat.unregisterDeviceToken")
        ...
        if (200 ... 299).contains(responseCode) {
            do {
                ...
                LogManager.logError("Failed to decode successful response for blue.catbird.mlsChat.unregisterDeviceToken: \(error)")
