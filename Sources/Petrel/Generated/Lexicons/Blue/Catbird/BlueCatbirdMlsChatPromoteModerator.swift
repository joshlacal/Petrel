...
public enum BlueCatbirdMlsChatPromoteModerator {
...
public extension ATProtoClient.Blue.Catbird.MlsChat {
    ...
    func promoteModerator(
        ...
        let serviceDID = await networkService.getServiceDID(for: "blue.catbird.mlsChat.promoteModerator")
        ...
        if (200 ... 299).contains(responseCode) {
            do {
                ...
                LogManager.logError("Failed to decode successful response for blue.catbird.mlsChat.promoteModerator: \(error)")
