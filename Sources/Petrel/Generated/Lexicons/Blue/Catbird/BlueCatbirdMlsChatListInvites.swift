...
public enum BlueCatbirdMlsChatListInvites {
    ...
    public struct Output: ATProtocolCodable {
        ...
        public init(from decoder: Decoder) throws {
            ...
            invites = try container.decode([BlueCatbirdMlsChatCreateInvite.InviteView].self, forKey: .invites)
        }
...
public extension ATProtoClient.Blue.Catbird.MlsChat {
    ...
    func listInvites(input: BlueCatbirdMlsChatListInvites.Parameters) async throws -> (responseCode: Int, data: BlueCatbirdMlsChatListInvites.Output?) {
        ...
        let serviceDID = await networkService.getServiceDID(for: "blue.catbird.mlsChat.listInvites")
        ...
        if (200 ... 299).contains(responseCode) {
            do {
                ...
                LogManager.logError("Failed to decode successful response for blue.catbird.mlsChat.listInvites: \(error)")
