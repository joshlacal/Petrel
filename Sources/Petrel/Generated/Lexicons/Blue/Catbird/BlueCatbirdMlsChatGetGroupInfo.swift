...
public enum BlueCatbirdMlsChatGetGroupInfo {
...
public extension ATProtoClient.Blue.Catbird.MlsChat {
    ...
    func getGroupInfo(input: BlueCatbirdMlsChatGetGroupInfo.Parameters) async throws -> (responseCode: Int, data: BlueCatbirdMlsChatGetGroupInfo.Output?) {
        ...
        let serviceDID = await networkService.getServiceDID(for: "blue.catbird.mlsChat.getGroupInfo")
        ...
        if (200 ... 299).contains(responseCode) {
            do {
                ...
                LogManager.logError("Failed to decode successful response for blue.catbird.mlsChat.getGroupInfo: \(error)")
