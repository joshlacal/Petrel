...
extension ATProtoClient.Blue.Catbird.MlsChat {
    ...
    public func publishKeyPackage(
        ...
        let serviceDID = await networkService.getServiceDID(for: "blue.catbird.mlsChat.publishKeyPackage")
        ...
        if (200...299).contains(responseCode) {
            do {
                ...
                LogManager.logError("Failed to decode successful response for blue.catbird.mlsChat.publishKeyPackage: \(error)")
