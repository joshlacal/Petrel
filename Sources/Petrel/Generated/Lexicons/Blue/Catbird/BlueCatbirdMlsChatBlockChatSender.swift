...
extension ATProtoClient.Blue.Catbird.MlsChat {
    ...
    public func blockChatSender(
        ...
        let endpoint = "blue.catbird.mlsChat.blockChatSender"
        ...
        let serviceDID = await networkService.getServiceDID(for: "blue.catbird.mlsChat.blockChatSender")
        ...
        if (200...299).contains(responseCode) {
            do {
                ...
                LogManager.logError("Failed to decode successful response for blue.catbird.mlsChat.blockChatSender: \(error)")
