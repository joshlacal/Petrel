...
public enum BlueCatbirdMlsChatGetPendingDeviceAdditions {
...
public extension ATProtoClient.Blue.Catbird.MlsChat {
    ...
    func getPendingDeviceAdditions(input: BlueCatbirdMlsChatGetPendingDeviceAdditions.Parameters) async throws -> (responseCode: Int, data: BlueCatbirdMlsChatGetPendingDeviceAdditions.Output?) {
        ...
        let serviceDID = await networkService.getServiceDID(for: "blue.catbird.mlsChat.getPendingDeviceAdditions")
        ...
        if (200 ... 299).contains(responseCode) {
            do {
                ...
                LogManager.logError("Failed to decode successful response for blue.catbird.mlsChat.getPendingDeviceAdditions: \(error)")
