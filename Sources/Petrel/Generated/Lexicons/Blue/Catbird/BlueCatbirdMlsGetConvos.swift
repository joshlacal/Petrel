...
public enum BlueCatbirdMlsGetConvos {
    ...
    public struct Output: ATProtocolCodable {
        ...
        public init(from decoder: Decoder) throws {
            ...
            conversations = try container.decode([BlueCatbirdMlsDefs.ConvoView].self, forKey: .conversations)
...
public extension ATProtoClient.Blue.Catbird.Mls {
    ...
    func getConvos(input: BlueCatbirdMlsGetConvos.Parameters) async throws -> (responseCode: Int, data: BlueCatbirdMlsGetConvos.Output?) {
