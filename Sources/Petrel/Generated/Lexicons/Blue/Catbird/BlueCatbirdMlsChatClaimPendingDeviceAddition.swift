...
public struct Output: ATProtocolCodable {
        ...
        public let keyPackage: BlueCatbirdMlsChatDefs.KeyPackageRef?
        ...
        public init(
            ...
            keyPackage: BlueCatbirdMlsChatDefs.KeyPackageRef? = nil,
...
extension ATProtoClient.Blue.Catbird.MlsChat {
    ...
    public func claimPendingDeviceAddition(
        ...
        let endpoint = "blue.catbird.mlsChat.claimPendingDeviceAddition"
        ...
        let serviceDID = await networkService.getServiceDID(for: "blue.catbird.mlsChat.claimPendingDeviceAddition")
        ...
        if (200...299).contains(responseCode) {
            do {
                ...
                LogManager.logError("Failed to decode successful response for blue.catbird.mlsChat.claimPendingDeviceAddition: \(error)")
