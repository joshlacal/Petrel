...
extension ATProtoClient.Blue.Catbird.MlsChat {
    ...
    public func getRequestCount() async throws -> (responseCode: Int, data: BlueCatbirdMlsChatGetRequestCount.Output?) {
        ...
        let serviceDID = await networkService.getServiceDID(for: "blue.catbird.mlsChat.getRequestCount")
        ...
        if (200...299).contains(responseCode) {
            do {
                ...
                LogManager.logError("Failed to decode successful response for blue.catbird.mlsChat.getRequestCount: \(error)")
