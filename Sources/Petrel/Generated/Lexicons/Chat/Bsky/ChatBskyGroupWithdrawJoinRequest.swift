...
public enum ChatBskyGroupWithdrawJoinRequest {
    ...
    public enum Error: String, Swift.Error, ATProtoErrorType, CustomStringConvertible {
        case invalidJoinRequest = "InvalidJoinRequest."
...
public extension ATProtoClient.Chat.Bsky.Group {
    ...
    func withdrawJoinRequest(
        input: ChatBskyGroupWithdrawJoinRequest.Input

    ) async throws -> (responseCode: Int, data: ChatBskyGroupWithdrawJoinRequest.Output?) {
        let endpoint = "chat.bsky.group.withdrawJoinRequest"
        ...
        let serviceDID = await networkService.getServiceDID(for: "chat.bsky.group.withdrawJoinRequest")
        ...
        if (200 ... 299).contains(responseCode) {
            ...
            do {
                ...
                let decodedData = try decoder.decode(ChatBskyGroupWithdrawJoinRequest.Output.self, from: responseData)
