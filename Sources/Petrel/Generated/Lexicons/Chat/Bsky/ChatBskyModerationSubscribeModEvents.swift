...
public struct EventGroupChatCreated: ATProtocolCodable, ATProtocolValue {
        ...
        public init(from decoder: Decoder) throws {
            let container = try decoder.container(keyedBy: CodingKeys.self)
            do {
                self.actorDid = try container.decode(DID.self, forKey: .actorDid)
            } catch {
                LogManager.logError("Decoding error for required property 'actorDid': \(error)")
                throw error
            }
            do {
                self.convoCreatedAt = try container.decode(ATProtocolDate.self, forKey: .convoCreatedAt)
            } catch {
            ...
            do {
                self.groupMemberCount = try container.decode(Int.self, forKey: .groupMemberCount)
            } catch {
            ...
            do {
                self.initialMemberDids = try container.decode([DID].self, forKey: .initialMemberDids)
            } catch {
                LogManager.logError("Decoding error for required property 'initialMemberDids': \(error)")
                throw error
            }
            do {
                self.ownerDid = try container.decode(DID.self, forKey: .ownerDid)
            } catch {
...
public struct EventGroupChatMemberAdded: ATProtocolCodable, ATProtocolValue {
        ...
        public init(from decoder: Decoder) throws {
            ...
            do {
                self.requestMembersCount = try container.decode(Int.self, forKey: .requestMembersCount)
            } catch {
            ...
            do {
                self.subjectDid = try container.decode(DID.self, forKey: .subjectDid)
            } catch {
                LogManager.logError("Decoding error for required property 'subjectDid': \(error)")
                throw error
            }
            do {
                self.subjectFollowsOwner = try container.decode(Bool.self, forKey: .subjectFollowsOwner)
            } catch {
...
public struct EventGroupChatMemberJoined: ATProtocolCodable, ATProtocolValue {
        ...
        public init(from decoder: Decoder) throws {
            ...
            do {
                self.joinLinkCode = try container.decode(String.self, forKey: .joinLinkCode)
            } catch {
...
public struct EventChatAccepted: ATProtocolCodable, ATProtocolValue {
        ...
        public init(from decoder: Decoder) throws {
            ...
            do {
                self.groupMemberCount = try container.decodeIfPresent(Int.self, forKey: .groupMemberCount)
            } catch {
                // Forward compatibility: a malformed or unknown-shaped optional field
                // must not fail the whole response.
                LogManager.logWarning("Decoding error for optional property 'groupMemberCount' — degrading to nil: \(error)")
                self.groupMemberCount = nil
            }
            do {
            ...
            do {
                self.ownerDid = try container.decodeIfPresent(DID.self, forKey: .ownerDid)
            } catch {
                // Forward compatibility: a malformed or unknown-shaped optional field
                // must not fail the whole response.
...
public struct EventGroupChatMemberLeft: ATProtocolCodable, ATProtocolValue {
        ...
        public init(from decoder: Decoder) throws {
            ...
            do {
                self.leaveMethod = try container.decode(String.self, forKey: .leaveMethod)
            } catch {
...
public struct EventGroupChatUpdated: ATProtocolCodable, ATProtocolValue {
        ...
        public init(from decoder: Decoder) throws {
            ...
            do {
                self.joinLinkCode = try container.decodeIfPresent(String.self, forKey: .joinLinkCode)
            } catch {
                // Forward compatibility: a malformed or unknown-shaped optional field
                // must not fail the whole response.
                LogManager.logWarning("Decoding error for optional property 'joinLinkCode' — degrading to nil: \(error)")
                self.joinLinkCode = nil
            }
            do {
                self.joinLinkFollowersOnly = try container.decodeIfPresent(Bool.self, forKey: .joinLinkFollowersOnly)
            } catch {
                // Forward compatibility: a malformed or unknown-shaped optional field
                // must not fail the whole response.
                LogManager.logWarning("Decoding error for optional property 'joinLinkFollowersOnly' — degrading to nil: \(error)")
                self.joinLinkFollowersOnly = nil
            }
            do {
                self.joinLinkRequiresApproval = try container.decodeIfPresent(Bool.self, forKey: .joinLinkRequiresApproval)
            } catch {
                // Forward compatibility: a malformed or unknown-shaped optional field
                // must not fail the whole response.
                LogManager.logWarning("Decoding error for optional property 'joinLinkRequiresApproval' — degrading to nil: \(error)")
                self.joinLinkRequiresApproval = nil
            }
            do {
...
public enum Message: Codable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        case .eventGroupChatCreated(let value):
            try value.encode(to: encoder)

        case .eventGroupChatMemberAdded(let value):
            try value.encode(to: encoder)

        case .eventGroupChatMemberJoined(let value):
            try value.encode(to: encoder)

        case .eventGroupChatJoinRequest(let value):
            try value.encode(to: encoder)

        case .eventGroupChatJoinRequestApproved(let value):
            try value.encode(to: encoder)

        case .eventGroupChatJoinRequestRejected(let value):
            try value.encode(to: encoder)

        case .eventChatAccepted(let value):
            try value.encode(to: encoder)

        case .eventGroupChatMemberLeft(let value):
            try value.encode(to: encoder)

        case .eventGroupChatUpdated(let value):
            try value.encode(to: encoder)

        case .eventRateLimitExceeded(let value):
            try value.encode(to: encoder)
