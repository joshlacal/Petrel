...
public struct ChatBskyNotificationPutPreferences { 
...
public struct Input: ATProtocolCodable {
        ...
        public init(from decoder: Decoder) throws {
            ...
            self.chat = try container.decodeIfPresent(ChatBskyNotificationDefs.ChatPreference.self, forKey: .chat)
            self.chatRequest = try container.decodeIfPresent(ChatBskyNotificationDefs.ChatPreference.self, forKey: .chatRequest)
        }
...
public struct Output: ATProtocolCodable {
        ...
        public init(from decoder: Decoder) throws {
            ...
            self.preferences = try container.decode(ChatBskyNotificationDefs.Preferences.self, forKey: .preferences)
...
extension ATProtoClient.Chat.Bsky.Notification {
    // MARK: - putPreferences
