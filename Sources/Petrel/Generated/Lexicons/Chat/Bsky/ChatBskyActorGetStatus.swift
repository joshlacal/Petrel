...
public struct ChatBskyActorGetStatus { 
...
public struct Output: ATProtocolCodable {
        ...
        public init(from decoder: Decoder) throws {
            ...
            self.chatDisabled = try container.decode(Bool.self, forKey: .chatDisabled)
            
            
            
            
            self.canCreateGroups = try container.decode(Bool.self, forKey: .canCreateGroups)
            
            
            
            
            self.groupMemberLimit = try container.decode(Int.self, forKey: .groupMemberLimit)
...
extension ATProtoClient.Chat.Bsky.Actor {
    ...
    public func getStatus() async throws -> (responseCode: Int, data: ChatBskyActorGetStatus.Output?) {
