...
public struct ChatBskyNotificationGetPreferences { 
...
extension ATProtoClient.Chat.Bsky.Notification {
    ...
    public func getPreferences() async throws -> (responseCode: Int, data: ChatBskyNotificationGetPreferences.Output?) {
