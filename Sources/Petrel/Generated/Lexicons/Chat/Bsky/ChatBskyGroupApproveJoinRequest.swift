...
public struct ChatBskyGroupApproveJoinRequest {

    public static let typeIdentifier = "chat.bsky.group.approveJoinRequest"
public struct Input: ATProtocolCodable {
        ...
        public init(from decoder: Decoder) throws {
            ...
            self.member = try container.decode(DID.self, forKey: .member)
        }
...
extension ATProtoClient.Chat.Bsky.Group {
    ...
    public func approveJoinRequest(
    ...
    ) async throws -> (responseCode: Int, data: ChatBskyGroupApproveJoinRequest.Output?) {
        let endpoint = "chat.bsky.group.approveJoinRequest"
        ...
        let serviceDID = await networkService.getServiceDID(for: "chat.bsky.group.approveJoinRequest")
        ...
        if (200...299).contains(responseCode) {
            ...
            do {
                ...
                let decodedData = try decoder.decode(ChatBskyGroupApproveJoinRequest.Output.self, from: responseData)

                return (responseCode, decodedData)
            } catch {
                // Log the decoding error for debugging but still return the response code
                LogManager.logError("Failed to decode successful response for chat.bsky.group.approveJoinRequest: \(error)")
