...
public enum OutputLogsUnion: Codable, ATProtocolCodable, ATProtocolValue, Sendable, Equatable {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        case .chatBskyConvoDefsLogOutgoingJoinRequest(let value):
            ...
            try value.encode(to: encoder)
        case .chatBskyConvoDefsLogWithdrawIncomingJoinRequest(let value):
            try container.encode("chat.bsky.convo.defs#logWithdrawIncomingJoinRequest", forKey: .type)
            try value.encode(to: encoder)
        case .chatBskyConvoDefsLogWithdrawOutgoingJoinRequest(let value):
            try container.encode("chat.bsky.convo.defs#logWithdrawOutgoingJoinRequest", forKey: .type)
            try value.encode(to: encoder)
        case .chatBskyConvoDefsLogReadJoinRequests(let value):
    ...
    public static func == (lhs: OutputLogsUnion, rhs: OutputLogsUnion) -> Bool {
        ...
        case (.chatBskyConvoDefsLogOutgoingJoinRequest(let lhsValue),
            ...
            return lhsValue == rhsValue
        case (.chatBskyConvoDefsLogWithdrawIncomingJoinRequest(let lhsValue),
              .chatBskyConvoDefsLogWithdrawIncomingJoinRequest(let rhsValue)):
            return lhsValue == rhsValue
        case (.chatBskyConvoDefsLogWithdrawOutgoingJoinRequest(let lhsValue),
              .chatBskyConvoDefsLogWithdrawOutgoingJoinRequest(let rhsValue)):
            return lhsValue == rhsValue
        case (.chatBskyConvoDefsLogReadJoinRequests(let lhsValue),
              .chatBskyConvoDefsLogReadJoinRequests(let rhsValue)):
            return lhsValue == rhsValue
