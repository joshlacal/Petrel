...
public struct ChatBskyGroupGetJoinLinkPreviews { 
...
public struct Output: ATProtocolCodable {
        ...
        public init(from decoder: Decoder) throws {
            ...
            self.joinLinkPreviews = try container.decode([OutputJoinLinkPreviewsUnion].self, forKey: .joinLinkPreviews)
...
public enum OutputJoinLinkPreviewsUnion: Codable, ATProtocolCodable, ATProtocolValue, Sendable, Equatable {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        switch self {
        case .chatBskyGroupDefsJoinLinkPreviewView(let value):
            try container.encode("chat.bsky.group.defs#joinLinkPreviewView", forKey: .type)
            try value.encode(to: encoder)
        case .chatBskyGroupDefsDisabledJoinLinkPreviewView(let value):
            try container.encode("chat.bsky.group.defs#disabledJoinLinkPreviewView", forKey: .type)
            try value.encode(to: encoder)
        case .chatBskyGroupDefsInvalidJoinLinkPreviewView(let value):
    ...
    public static func == (lhs: OutputJoinLinkPreviewsUnion, rhs: OutputJoinLinkPreviewsUnion) -> Bool {
        switch (lhs, rhs) {
        case (.chatBskyGroupDefsJoinLinkPreviewView(let lhsValue),
              .chatBskyGroupDefsJoinLinkPreviewView(let rhsValue)):
            return lhsValue == rhsValue
        case (.chatBskyGroupDefsDisabledJoinLinkPreviewView(let lhsValue),
              .chatBskyGroupDefsDisabledJoinLinkPreviewView(let rhsValue)):
            return lhsValue == rhsValue
        case (.chatBskyGroupDefsInvalidJoinLinkPreviewView(let lhsValue),
              .chatBskyGroupDefsInvalidJoinLinkPreviewView(let rhsValue)):
            return lhsValue == rhsValue
...
extension ATProtoClient.Chat.Bsky.Group {
    ...
    public func getJoinLinkPreviews(input: ChatBskyGroupGetJoinLinkPreviews.Parameters) async throws -> (responseCode: Int, data: ChatBskyGroupGetJoinLinkPreviews.Output?) {
