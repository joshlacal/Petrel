...
public struct JoinLinkPreviewView: ATProtocolCodable, ATProtocolValue {
        ...
        public init(from decoder: Decoder) throws {
            ...
            do {
                self.viewer = try container.decodeIfPresent(JoinLinkViewerState.self, forKey: .viewer)
            } catch {
                // Forward compatibility: a malformed or unknown-shaped optional field
                // must not fail the whole response.
...
public struct JoinRequestConvoView: ATProtocolCodable, ATProtocolValue {
        ...
        public init(from decoder: Decoder) throws {
            ...
            do {
                self.viewer = try container.decode(JoinLinkViewerState.self, forKey: .viewer)
            } catch {
