...
public struct ChatBskyModerationGetConvos { 
...
public struct Output: ATProtocolCodable {
        ...
        public init(from decoder: Decoder) throws {
            ...
            self.convos = try container.decode([ChatBskyModerationDefs.ConvoView].self, forKey: .convos)
...
extension ATProtoClient.Chat.Bsky.Moderation {
    ...
    public func getConvos(input: ChatBskyModerationGetConvos.Parameters) async throws -> (responseCode: Int, data: ChatBskyModerationGetConvos.Output?) {
