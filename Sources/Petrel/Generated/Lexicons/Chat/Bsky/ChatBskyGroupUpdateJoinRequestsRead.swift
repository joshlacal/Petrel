...
public extension ATProtoClient.Chat.Bsky.Group {
    ...
    func updateJoinRequestsRead(
        input: ChatBskyGroupUpdateJoinRequestsRead.Input

    ) async throws -> (responseCode: Int, data: ChatBskyGroupUpdateJoinRequestsRead.Output?) {
        let endpoint = "chat.bsky.group.updateJoinRequestsRead"
        ...
        let serviceDID = await networkService.getServiceDID(for: "chat.bsky.group.updateJoinRequestsRead")
        ...
        if (200 ... 299).contains(responseCode) {
            ...
            do {
                ...
                let decodedData = try decoder.decode(ChatBskyGroupUpdateJoinRequestsRead.Output.self, from: responseData)
