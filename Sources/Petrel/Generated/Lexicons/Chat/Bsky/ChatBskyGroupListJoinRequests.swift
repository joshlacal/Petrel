...
public struct ChatBskyGroupListJoinRequests {
...
public struct Output: ATProtocolCodable {
        ...
        public init(from decoder: Decoder) throws {
            ...
            self.requests = try container.decode([ChatBskyGroupDefs.JoinRequestView].self, forKey: .requests)
...
extension ATProtoClient.Chat.Bsky.Group {
    ...
    public func listJoinRequests(input: ChatBskyGroupListJoinRequests.Parameters) async throws -> (responseCode: Int, data: ChatBskyGroupListJoinRequests.Output?) {
