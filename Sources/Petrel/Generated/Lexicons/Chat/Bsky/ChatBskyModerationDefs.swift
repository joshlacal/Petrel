...
public struct ChatBskyModerationDefs { 
...
public struct GroupConvo: ATProtocolCodable, ATProtocolValue {
        ...
        public init(from decoder: Decoder) throws {
            ...
            do {
                self.joinRequestCount = try container.decode(Int.self, forKey: .joinRequestCount)
            } catch {
                LogManager.logError("Decoding error for required property 'joinRequestCount': \(error)")
                throw error
            }
            do {
                self.lockStatus = try container.decode(ChatBskyConvoDefs.ConvoLockStatus.self, forKey: .lockStatus)
            } catch {
...
public enum ConvoViewKindUnion: Codable, ATProtocolCodable, ATProtocolValue, Sendable, Equatable {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        switch self {
        case .chatBskyModerationDefsDirectConvo(let value):
            try container.encode("chat.bsky.moderation.defs#directConvo", forKey: .type)
            try value.encode(to: encoder)
        case .chatBskyModerationDefsGroupConvo(let value):
    ...
    public static func == (lhs: ConvoViewKindUnion, rhs: ConvoViewKindUnion) -> Bool {
        switch (lhs, rhs) {
        case (.chatBskyModerationDefsDirectConvo(let lhsValue),
              .chatBskyModerationDefsDirectConvo(let rhsValue)):
            return lhsValue == rhsValue
        case (.chatBskyModerationDefsGroupConvo(let lhsValue),
              .chatBskyModerationDefsGroupConvo(let rhsValue)):
            return lhsValue == rhsValue
