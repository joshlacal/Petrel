...
public extension ATProtoClient.Chat.Bsky.Convo {
    ...
    func muteConvo(
        ...
        let serviceDID = await networkService.getServiceDID(for: "chat.bsky.convo.muteConvo")
        ...
        if (200 ... 299).contains(responseCode) {
            do {
                ...
                LogManager.logError("Failed to decode successful response for chat.bsky.convo.muteConvo: \(error)")
