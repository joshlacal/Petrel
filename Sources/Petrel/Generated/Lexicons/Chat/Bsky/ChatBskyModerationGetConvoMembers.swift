...
public struct ChatBskyModerationGetConvoMembers { 
...
extension ATProtoClient.Chat.Bsky.Moderation {
    ...
    public func getConvoMembers(input: ChatBskyModerationGetConvoMembers.Parameters) async throws -> (responseCode: Int, data: ChatBskyModerationGetConvoMembers.Output?) {
        ...
        if (200...299).contains(responseCode) {
            ...
            if let atprotoError = ATProtoErrorParser.parse(
                ...
                errorType: ChatBskyModerationGetConvoMembers.Error.self
            ) {
                throw atprotoError
            }
