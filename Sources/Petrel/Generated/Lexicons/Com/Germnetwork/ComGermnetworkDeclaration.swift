...
public struct ComGermnetworkDeclaration: ATProtocolCodable, ATProtocolValue { 
    ...
    public static let typeIdentifier = "com.germnetwork.declaration"
        ...
        public init(from decoder: Decoder) throws {
            ...
            self.currentKey = try container.decode(Bytes.self, forKey: .currentKey)
            self.messageMe = try container.decodeIfPresent(MessageMe.self, forKey: .messageMe)
            self.keyPackage = try container.decodeIfPresent(Bytes.self, forKey: .keyPackage)
            self.continuityProofs = try container.decodeIfPresent([Bytes].self, forKey: .continuityProofs)
        }
