...
public struct ComAtprotoSpaceListSpaces { 
...
public struct Output: ATProtocolCodable {
        ...
        public init(from decoder: Decoder) throws {
            ...
            self.spaces = try container.decode([SpaceView].self, forKey: .spaces)
...
extension ATProtoClient.Com.Atproto.Space {
    ...
    public func listSpaces(input: ComAtprotoSpaceListSpaces.Parameters) async throws -> (responseCode: Int, data: ComAtprotoSpaceListSpaces.Output?) {
