...
public struct ComAtprotoSpaceGetSpaceCredential { 
...
public struct Input: ATProtocolCodable {
        ...
        public init(from decoder: Decoder) throws {
            ...
            self.clientAttestation = try container.decodeIfPresent(String.self, forKey: .clientAttestation)
        }
...
extension ATProtoClient.Com.Atproto.Space {
    ...
    public func getSpaceCredential(
