...
public struct ComAtprotoSpacePutRecord { 
...
public struct Input: ATProtocolCodable {
        ...
        public init(space: SpaceRef, repo: DID, collection: NSID, rkey: RecordKey, validate: Bool? = nil, record: ATProtocolValueContainer) {
            self.space = space
            self.repo = repo
...
extension ATProtoClient.Com.Atproto.Space {
    ...
    public func putRecord(
    ...
    ) async throws -> (responseCode: Int, data: ComAtprotoSpacePutRecord.Output?) {
        let endpoint = "com.atproto.space.putRecord"
        ...
        let serviceDID = await networkService.getServiceDID(for: "com.atproto.space.putRecord")
        ...
        if (200...299).contains(responseCode) {
            ...
            do {
                ...
                let decodedData = try decoder.decode(ComAtprotoSpacePutRecord.Output.self, from: responseData)
            ...
            if let atprotoError = ATProtoErrorParser.parse(
                ...
                errorType: ComAtprotoSpacePutRecord.Error.self
            ) {
                throw atprotoError
            }
