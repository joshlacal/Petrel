...
public struct ComAtprotoSpaceGetLatestCommit { 
...
public struct Output: ATProtocolCodable {
        ...
        public init(from decoder: Decoder) throws {
            ...
            self.commit = try container.decode(ComAtprotoSpaceDefs.SignedCommit.self, forKey: .commit)
...
extension ATProtoClient.Com.Atproto.Space {
    ...
    public func getLatestCommit(input: ComAtprotoSpaceGetLatestCommit.Parameters) async throws -> (responseCode: Int, data: ComAtprotoSpaceGetLatestCommit.Output?) {
