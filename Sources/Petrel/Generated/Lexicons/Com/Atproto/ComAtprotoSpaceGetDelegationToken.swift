...
public struct ComAtprotoSpaceGetDelegationToken { 
...
extension ATProtoClient.Com.Atproto.Space {
    ...
    public func getDelegationToken(input: ComAtprotoSpaceGetDelegationToken.Parameters) async throws -> (responseCode: Int, data: ComAtprotoSpaceGetDelegationToken.Output?) {
