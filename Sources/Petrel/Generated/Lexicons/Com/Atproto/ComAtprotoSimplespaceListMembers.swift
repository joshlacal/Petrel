...
public enum ComAtprotoSimplespaceListMembers {
    ...
    public static let endpointDescriptor = XRPCMethodDescriptor(
        nsid: "com.atproto.simplespace.listMembers", kind: "query",
...
public extension ATProtoClient.Com.Atproto.Simplespace {
    ...
    func listMembers(input: ComAtprotoSimplespaceListMembers.Parameters) async throws -> (responseCode: Int, data: ComAtprotoSimplespaceListMembers.Output?) {
