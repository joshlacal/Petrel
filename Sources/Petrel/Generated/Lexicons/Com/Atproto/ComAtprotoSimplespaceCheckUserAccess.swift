...
public struct ComAtprotoSimplespaceCheckUserAccess { 
...
extension ATProtoClient.Com.Atproto.Simplespace {
    ...
    public func checkUserAccess(input: ComAtprotoSimplespaceCheckUserAccess.Parameters) async throws -> (responseCode: Int, data: ComAtprotoSimplespaceCheckUserAccess.Output?) {
