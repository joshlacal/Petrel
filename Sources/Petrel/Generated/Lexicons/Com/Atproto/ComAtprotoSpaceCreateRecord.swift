...
public struct ComAtprotoSpaceCreateRecord { 
...
public struct Input: ATProtocolCodable {
        ...
        public init(space: SpaceRef, repo: DID, collection: NSID, rkey: RecordKey? = nil, validate: Bool? = nil, record: ATProtocolValueContainer) {
            self.space = space
            self.repo = repo
...
extension ATProtoClient.Com.Atproto.Space {
    ...
    public func createRecord(
        ...
        input: ComAtprotoSpaceCreateRecord.Input
        
    ) async throws -> (responseCode: Int, data: ComAtprotoSpaceCreateRecord.Output?) {
        let endpoint = "com.atproto.space.createRecord"
        ...
        let serviceDID = await networkService.getServiceDID(for: "com.atproto.space.createRecord")
        ...
        if (200...299).contains(responseCode) {
            ...
            do {
                ...
                let decodedData = try decoder.decode(ComAtprotoSpaceCreateRecord.Output.self, from: responseData)
            ...
            if let atprotoError = ATProtoErrorParser.parse(
                ...
                errorType: ComAtprotoSpaceCreateRecord.Error.self
            ) {
                throw atprotoError
            }
