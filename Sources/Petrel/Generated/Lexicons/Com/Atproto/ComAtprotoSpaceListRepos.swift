...
public struct ComAtprotoSpaceListRepos { 
...
extension ATProtoClient.Com.Atproto.Space {
    ...
    public func listRepos(input: ComAtprotoSpaceListRepos.Parameters) async throws -> (responseCode: Int, data: ComAtprotoSpaceListRepos.Output?) {
