...
public struct ComAtprotoSpaceListRepoOps { 
...
public struct OpEntry: ATProtocolCodable, ATProtocolValue {
        ...
        public init(from decoder: Decoder) throws {
            ...
            do {
                self.value = try container.decodeIfPresent(ATProtocolValueContainer.self, forKey: .value)
            } catch {
...
public struct Output: ATProtocolCodable {
        ...
        public init(from decoder: Decoder) throws {
            ...
            self.ops = try container.decode([OpEntry].self, forKey: .ops)
            
            
            
            
            do {
                self.commit = try container.decodeIfPresent(ComAtprotoSpaceDefs.SignedCommit.self, forKey: .commit)
            } catch {
...
extension ATProtoClient.Com.Atproto.Space {
    ...
    public func listRepoOps(input: ComAtprotoSpaceListRepoOps.Parameters) async throws -> (responseCode: Int, data: ComAtprotoSpaceListRepoOps.Output?) {
