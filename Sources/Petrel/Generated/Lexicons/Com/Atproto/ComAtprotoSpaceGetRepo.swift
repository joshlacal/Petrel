...
public struct ComAtprotoSpaceGetRepo { 
...
extension ATProtoClient.Com.Atproto.Space {
    ...
    public func getRepo(input: ComAtprotoSpaceGetRepo.Parameters) async throws -> (responseCode: Int, data: ComAtprotoSpaceGetRepo.Output?) {
