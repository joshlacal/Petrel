...
public struct ComAtprotoSpaceGetBlob { 
...
extension ATProtoClient.Com.Atproto.Space {
    ...
    public func getBlob(input: ComAtprotoSpaceGetBlob.Parameters) async throws -> (responseCode: Int, data: ComAtprotoSpaceGetBlob.Output?) {
