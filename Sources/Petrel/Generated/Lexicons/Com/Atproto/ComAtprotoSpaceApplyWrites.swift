...
public struct ComAtprotoSpaceApplyWrites { 
...
public enum InputWritesUnion: Codable, ATProtocolCodable, ATProtocolValue, Sendable, Equatable {
    ...
    public static func == (lhs: InputWritesUnion, rhs: InputWritesUnion) -> Bool {
        switch (lhs, rhs) {
        case (.comAtprotoSpaceApplyWritesCreate(let lhsValue),
              .comAtprotoSpaceApplyWritesCreate(let rhsValue)):
            return lhsValue == rhsValue
        case (.comAtprotoSpaceApplyWritesUpdate(let lhsValue),
              .comAtprotoSpaceApplyWritesUpdate(let rhsValue)):
            return lhsValue == rhsValue
        case (.comAtprotoSpaceApplyWritesDelete(let lhsValue),
              .comAtprotoSpaceApplyWritesDelete(let rhsValue)):
            return lhsValue == rhsValue
...
public enum OutputResultsUnion: Codable, ATProtocolCodable, ATProtocolValue, Sendable, Equatable {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        switch self {
        case .comAtprotoSpaceApplyWritesCreateResult(let value):
            try container.encode("com.atproto.space.applyWrites#createResult", forKey: .type)
            try value.encode(to: encoder)
        case .comAtprotoSpaceApplyWritesUpdateResult(let value):
            try container.encode("com.atproto.space.applyWrites#updateResult", forKey: .type)
            try value.encode(to: encoder)
        case .comAtprotoSpaceApplyWritesDeleteResult(let value):
    ...
    public static func == (lhs: OutputResultsUnion, rhs: OutputResultsUnion) -> Bool {
        switch (lhs, rhs) {
        case (.comAtprotoSpaceApplyWritesCreateResult(let lhsValue),
              .comAtprotoSpaceApplyWritesCreateResult(let rhsValue)):
            return lhsValue == rhsValue
        case (.comAtprotoSpaceApplyWritesUpdateResult(let lhsValue),
              .comAtprotoSpaceApplyWritesUpdateResult(let rhsValue)):
            return lhsValue == rhsValue
        case (.comAtprotoSpaceApplyWritesDeleteResult(let lhsValue),
              .comAtprotoSpaceApplyWritesDeleteResult(let rhsValue)):
            return lhsValue == rhsValue
        case (.unexpected(let lhsValue), .unexpected(let rhsValue)):
            return lhsValue.isEqual(to: rhsValue)
        default:
