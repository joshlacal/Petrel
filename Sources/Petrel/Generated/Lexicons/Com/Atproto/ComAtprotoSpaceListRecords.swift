...
public struct ComAtprotoSpaceListRecords { 
...
extension ATProtoClient.Com.Atproto.Space {
    ...
    public func listRecords(input: ComAtprotoSpaceListRecords.Parameters) async throws -> (responseCode: Int, data: ComAtprotoSpaceListRecords.Output?) {
