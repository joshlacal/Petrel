...
public struct ComAtprotoSpaceGetRecord { 
...
extension ATProtoClient.Com.Atproto.Space {
    ...
    public func getRecord(input: ComAtprotoSpaceGetRecord.Parameters) async throws -> (responseCode: Int, data: ComAtprotoSpaceGetRecord.Output?) {
