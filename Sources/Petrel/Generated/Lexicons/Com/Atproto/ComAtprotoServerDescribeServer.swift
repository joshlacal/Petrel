...
public struct Output: ATProtocolCodable {
        ...
        public init(from decoder: Decoder) throws {
            ...
            do {
                ...
                self.phoneVerificationRequired = nil
            }
            ...
            do {
                self.blobUploadLimit = try container.decodeIfPresent(Int.self, forKey: .blobUploadLimit)
            } catch {
                // Forward compatibility: a malformed optional field must not fail the whole response.
                LogManager.logWarning("Decoding error for optional property 'blobUploadLimit' — degrading to nil: \(error)")
                self.blobUploadLimit = nil
            }
