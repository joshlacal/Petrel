...
public struct ToolsOzoneSetGetValues { 
...
public struct Output: ATProtocolCodable {
        ...
        public init(from decoder: Decoder) throws {
            ...
            self.set = try container.decode(ToolsOzoneSetDefs.SetView.self, forKey: .set)
...
extension ATProtoClient.Tools.Ozone.Set {
    ...
    public func getValues(input: ToolsOzoneSetGetValues.Parameters) async throws -> (responseCode: Int, data: ToolsOzoneSetGetValues.Output?) {
