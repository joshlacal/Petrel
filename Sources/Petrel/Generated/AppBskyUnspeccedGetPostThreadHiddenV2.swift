...
public enum AppBskyUnspeccedGetPostThreadHiddenV2 {
    ...
    public struct ThreadHiddenItem: ATProtocolCodable, ATProtocolValue {
        ...
        public init(from decoder: Decoder) throws {
            ...
            do {
                value = try container.decode(ThreadHiddenItemValueUnion.self, forKey: .value)
    ...
    public struct Output: ATProtocolCodable {
        ...
        public init(from decoder: Decoder) throws {
            ...
            thread = try container.decode([ThreadHiddenItem].self, forKey: .thread)
        }
...
public extension ATProtoClient.App.Bsky.Unspecced {
    ...
    func getPostThreadHiddenV2(input: AppBskyUnspeccedGetPostThreadHiddenV2.Parameters) async throws -> (responseCode: Int, data: AppBskyUnspeccedGetPostThreadHiddenV2.Output?) {
