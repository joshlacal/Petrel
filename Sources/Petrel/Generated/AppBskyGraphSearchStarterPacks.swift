...
extension ATProtoClient.App.Bsky.Graph {
    ...
    public func searchStarterPacks(input: AppBskyGraphSearchStarterPacks.Parameters) async throws -> (responseCode: Int, data: AppBskyGraphSearchStarterPacks.Output?) {
        ...
        let serviceDID = await networkService.getServiceDID(for: "app.bsky.graph.searchStarterPacks")
        ...
        if (200...299).contains(responseCode) {
            do {
                ...
                LogManager.logError("Failed to decode successful response for app.bsky.graph.searchStarterPacks: \(error)")
