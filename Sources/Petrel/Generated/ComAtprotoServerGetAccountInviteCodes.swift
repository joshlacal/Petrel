...
extension ATProtoClient.Com.Atproto.Server {
    ...
    public func getAccountInviteCodes(input: ComAtprotoServerGetAccountInviteCodes.Parameters) async throws -> (responseCode: Int, data: ComAtprotoServerGetAccountInviteCodes.Output?) {
        ...
        let serviceDID = await networkService.getServiceDID(for: "com.atproto.server.getAccountInviteCodes")
        ...
        if (200...299).contains(responseCode) {
            ...
            if let atprotoError = ATProtoErrorParser.parse(
                ...
                errorType: ComAtprotoServerGetAccountInviteCodes.Error.self
            ) {
                throw atprotoError
            }
