...
public struct AppBskyFeedGenerator: ATProtocolCodable, ATProtocolValue {
    ...
    public enum AppBskyFeedGeneratorLabelsUnion: Codable, ATProtocolCodable, ATProtocolValue {
        ...
        public init(from decoder: Decoder) throws {
            ...
            LogManager.logDebug("AppBskyFeedGeneratorLabelsUnion decoding: \(typeValue)")
            ...
            default:
                LogManager.logDebug("AppBskyFeedGeneratorLabelsUnion decoding encountered an unexpected type: \(typeValue)")
        ...
        public func encode(to encoder: Encoder) throws {
            ...
            case let .unexpected(ATProtocolValueContainer):
                LogManager.logDebug("AppBskyFeedGeneratorLabelsUnion encoding unexpected value")
