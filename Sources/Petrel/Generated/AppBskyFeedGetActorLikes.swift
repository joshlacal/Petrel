...
extension ATProtoClient.App.Bsky.Feed {
    ...
    public func getActorLikes(input: AppBskyFeedGetActorLikes.Parameters) async throws -> (responseCode: Int, data: AppBskyFeedGetActorLikes.Output?) {
        ...
        let serviceDID = await networkService.getServiceDID(for: "app.bsky.feed.getActorLikes")
        ...
        if (200...299).contains(responseCode) {
            do {
                ...
                LogManager.logError("Failed to decode successful response for app.bsky.feed.getActorLikes: \(error)")
            ...
            if let atprotoError = ATProtoErrorParser.parse(
                ...
                errorType: AppBskyFeedGetActorLikes.Error.self
            ) {
                throw atprotoError
            }
