...
public struct AppBskyActorProfile: ATProtocolCodable, ATProtocolValue {
    ...
    public enum AppBskyActorProfileLabelsUnion: Codable, ATProtocolCodable, ATProtocolValue {
        ...
        public init(from decoder: Decoder) throws {
            ...
            LogManager.logDebug("AppBskyActorProfileLabelsUnion decoding: \(typeValue)")
            ...
            default:
                LogManager.logDebug("AppBskyActorProfileLabelsUnion decoding encountered an unexpected type: \(typeValue)")
        ...
        public func encode(to encoder: Encoder) throws {
            ...
            case let .unexpected(ATProtocolValueContainer):
                LogManager.logDebug("AppBskyActorProfileLabelsUnion encoding unexpected value")
