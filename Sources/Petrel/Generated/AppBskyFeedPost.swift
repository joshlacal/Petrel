...
public struct AppBskyFeedPost: ATProtocolCodable, ATProtocolValue {
    ...
    public enum AppBskyFeedPostEmbedUnion: Codable, ATProtocolCodable, ATProtocolValue {
        ...
        public init(from decoder: Decoder) throws {
            ...
            LogManager.logDebug("AppBskyFeedPostEmbedUnion decoding: \(typeValue)")
            ...
            case "app.bsky.embed.recordWithMedia":
                LogManager.logDebug("Decoding as app.bsky.embed.recordWithMedia")
                let value = try AppBskyEmbedRecordWithMedia(from: decoder)
                self = .appBskyEmbedRecordWithMedia(value)
            default:
                LogManager.logDebug("AppBskyFeedPostEmbedUnion decoding encountered an unexpected type: \(typeValue)")
        ...
        public func encode(to encoder: Encoder) throws {
            ...
            case let .appBskyEmbedRecordWithMedia(value):
                LogManager.logDebug("Encoding app.bsky.embed.recordWithMedia")
                try container.encode("app.bsky.embed.recordWithMedia", forKey: .type)
                try value.encode(to: encoder)
            case let .unexpected(ATProtocolValueContainer):
                LogManager.logDebug("AppBskyFeedPostEmbedUnion encoding unexpected value")
        ...
        public func isEqual(to other: any ATProtocolValue) -> Bool {
            ...
            case let (.appBskyEmbedRecord(selfValue),
                ...
                return selfValue == otherValue
            case let (.appBskyEmbedRecordWithMedia(selfValue),
    ...
    public enum AppBskyFeedPostLabelsUnion: Codable, ATProtocolCodable, ATProtocolValue {
        ...
        public init(from decoder: Decoder) throws {
            let container = try decoder.container(keyedBy: CodingKeys.self)
            let typeValue = try container.decode(String.self, forKey: .type)
            LogManager.logDebug("AppBskyFeedPostLabelsUnion decoding: \(typeValue)")
            ...
            default:
                LogManager.logDebug("AppBskyFeedPostLabelsUnion decoding encountered an unexpected type: \(typeValue)")
                let unknownValue = try ATProtocolValueContainer(from: decoder)
                self = .unexpected(unknownValue)
            }
        }
        ...
        public func encode(to encoder: Encoder) throws {
            ...
            case let .comAtprotoLabelDefsSelfLabels(value):
                ...
                try value.encode(to: encoder)
            case let .unexpected(ATProtocolValueContainer):
                LogManager.logDebug("AppBskyFeedPostLabelsUnion encoding unexpected value")
                try ATProtocolValueContainer.encode(to: encoder)
            }
        }
