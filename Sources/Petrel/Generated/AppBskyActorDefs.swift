...
public struct AppBskyActorDefs {
    ...
    public struct ProfileViewBasic: ATProtocolCodable, ATProtocolValue {
        ...
        public init(
            did: DID, handle: Handle, displayName: String?, avatar: URI?, associated: ProfileAssociated?, viewer: ViewerState?, labels: [ComAtprotoLabelDefs.Label]?, createdAt: ATProtocolDate?
        ) {
            self.did = did
            self.handle = handle
    ...
    public struct ProfileView: ATProtocolCodable, ATProtocolValue {
        ...
        // Standard initializer
        public init(
            did: DID, handle: Handle, displayName: String?, description: String?, avatar: URI?, associated: ProfileAssociated?, indexedAt: ATProtocolDate?, createdAt: ATProtocolDate?, viewer: ViewerState?, labels: [ComAtprotoLabelDefs.Label]?
        ) {
            self.did = did
            self.handle = handle
            self.displayName = displayName
    ...
    public struct ContentLabelPref: ATProtocolCodable, ATProtocolValue {
        ...
        public func toCBORValue() throws -> Any {
            ...
            let labelValue = try (label as? DAGCBOREncodable)?.toCBORValue() ?? label
            map = map.adding(key: "label", value: labelValue)

            let visibilityValue = try (visibility as? DAGCBOREncodable)?.toCBORValue() ?? visibility
    ...
    public struct SavedFeedsPref: ATProtocolCodable, ATProtocolValue {
        ...
        public func toCBORValue() throws -> Any {
            ...
            let savedValue = try (saved as? DAGCBOREncodable)?.toCBORValue() ?? saved
    ...
    public struct MutedWord: ATProtocolCodable, ATProtocolValue {
        ...
        public func toCBORValue() throws -> Any {
            ...
            let targetsValue = try (targets as? DAGCBOREncodable)?.toCBORValue() ?? targets
    ...
    public struct Nux: ATProtocolCodable, ATProtocolValue {
        ...
        public func toCBORValue() throws -> Any {
            ...
            let completedValue = try (completed as? DAGCBOREncodable)?.toCBORValue() ?? completed
