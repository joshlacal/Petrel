...
public struct BlockRelationship: ATProtocolCodable, ATProtocolValue {
        ...
        public func isEqual(to other: any ATProtocolValue) -> Bool {
            ...
            if self.blockerDid != other.blockerDid {
                return false
            }
            ...
            if self.blockedDid != other.blockedDid {
                return false
            }
...
public enum Error: String, Swift.Error, ATProtoErrorType, CustomStringConvertible {
                ...
                case blueskyServiceUnavailable = "BlueskyServiceUnavailable"
    ...
    public func checkBlocks(input: BlueCatbirdMlsCheckBlocks.Parameters) async throws -> (responseCode: Int, data: BlueCatbirdMlsCheckBlocks.Output?) {
        ...
        if (200...299).contains(responseCode) {
            ...
            if let atprotoError = ATProtoErrorParser.parse(
                ...
                errorType: BlueCatbirdMlsCheckBlocks.Error.self
            ) {
                throw atprotoError
            }
