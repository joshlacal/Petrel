...
public indirect enum ViewRecordUnion: Codable, ATProtocolCodable, ATProtocolValue, Sendable, Equatable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        if depth > DecodingConfiguration.standard.threshold {
            if DecodingConfiguration.standard.debugMode {
                print("🔄 Deferring deep decode for ViewRecordUnion at depth \(depth), type: \(typeValue)")
            }
            ...
            do {
                ...
                case "app.bsky.embed.record#viewRecord":
                    let value = try await SafeDecoder.decode(
                        AppBskyEmbedRecord.ViewRecord.self,
                        from: pendingData.rawData
                    )
                    self = .appBskyEmbedRecordViewRecord(value)
                case "app.bsky.embed.record#viewNotFound":
                    let value = try await SafeDecoder.decode(
                        AppBskyEmbedRecord.ViewNotFound.self,
                        from: pendingData.rawData
                    )
                    self = .appBskyEmbedRecordViewNotFound(value)
                case "app.bsky.embed.record#viewBlocked":
                    let value = try await SafeDecoder.decode(
                        AppBskyEmbedRecord.ViewBlocked.self,
                        from: pendingData.rawData
                    )
                    self = .appBskyEmbedRecordViewBlocked(value)
                case "app.bsky.embed.record#viewDetached":
                    let value = try await SafeDecoder.decode(
                        AppBskyEmbedRecord.ViewDetached.self,
                        from: pendingData.rawData
                    )
                    self = .appBskyEmbedRecordViewDetached(value)
                case "app.bsky.feed.defs#generatorView":
                    let value = try await SafeDecoder.decode(
                        AppBskyFeedDefs.GeneratorView.self,
                        from: pendingData.rawData
                    )
                    self = .appBskyFeedDefsGeneratorView(value)
                case "app.bsky.graph.defs#listView":
                    let value = try await SafeDecoder.decode(
                        AppBskyGraphDefs.ListView.self,
                        from: pendingData.rawData
                    )
                    self = .appBskyGraphDefsListView(value)
                case "app.bsky.labeler.defs#labelerView":
                    let value = try await SafeDecoder.decode(
                        AppBskyLabelerDefs.LabelerView.self,
                        from: pendingData.rawData
                    )
                    self = .appBskyLabelerDefsLabelerView(value)
                case "app.bsky.graph.defs#starterPackViewBasic":
                    let value = try await SafeDecoder.decode(
                        AppBskyGraphDefs.StarterPackViewBasic.self,
                        from: pendingData.rawData
                    )
                    self = .appBskyGraphDefsStarterPackViewBasic(value)
                default:
                ...
                if DecodingConfiguration.standard.debugMode {
                    print("❌ Failed to decode pending data for ViewRecordUnion: \(error)")
                }
...
public indirect enum ViewRecordEmbedsUnion: Codable, ATProtocolCodable, ATProtocolValue, Sendable, Equatable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        if depth > DecodingConfiguration.standard.threshold {
            if DecodingConfiguration.standard.debugMode {
                print("🔄 Deferring deep decode for ViewRecordEmbedsUnion at depth \(depth), type: \(typeValue)")
            }
    ...
    public mutating func loadPendingData() async {
        ...
        case .pending(let pendingData):
            do {
                ...
                case "app.bsky.embed.images#view":
                    let value = try await SafeDecoder.decode(
                        AppBskyEmbedImages.View.self,
                        from: pendingData.rawData
                    )
                    self = .appBskyEmbedImagesView(value)
                case "app.bsky.embed.video#view":
                    let value = try await SafeDecoder.decode(
                        AppBskyEmbedVideo.View.self,
                        from: pendingData.rawData
                    )
                    self = .appBskyEmbedVideoView(value)
                case "app.bsky.embed.external#view":
                    let value = try await SafeDecoder.decode(
                        AppBskyEmbedExternal.View.self,
                        from: pendingData.rawData
                    )
                    self = .appBskyEmbedExternalView(value)
                case "app.bsky.embed.record#view":
                ...
                case "app.bsky.embed.recordWithMedia#view":
                    let value = try await SafeDecoder.decode(
                        AppBskyEmbedRecordWithMedia.View.self,
                        from: pendingData.rawData
                    )
                    self = .appBskyEmbedRecordWithMediaView(value)
                default:
                ...
                if DecodingConfiguration.standard.debugMode {
                    print("❌ Failed to decode pending data for ViewRecordEmbedsUnion: \(error)")
                }
                self = .unexpected(ATProtocolValueContainer.string("Failed to decode: \(error)"))
            }
