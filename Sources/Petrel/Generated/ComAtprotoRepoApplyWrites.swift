...
public enum OutputResultsUnion: Codable, ATProtocolCodable, ATProtocolValue {
    ...
    public func isEqual(to other: any ATProtocolValue) -> Bool {
        ...
        switch (self, otherValue) {
            case (.comAtprotoRepoApplyWritesCreateResult(let selfValue), 
                .comAtprotoRepoApplyWritesCreateResult(let otherValue)):
                return selfValue == otherValue
            case (.comAtprotoRepoApplyWritesUpdateResult(let selfValue), 
                .comAtprotoRepoApplyWritesUpdateResult(let otherValue)):
                return selfValue == otherValue
            case (.comAtprotoRepoApplyWritesDeleteResult(let selfValue), 
                .comAtprotoRepoApplyWritesDeleteResult(let otherValue)):
                return selfValue == otherValue
            case (.unexpected(let selfValue), .unexpected(let otherValue)):
                return selfValue.isEqual(to: otherValue)
            default:
