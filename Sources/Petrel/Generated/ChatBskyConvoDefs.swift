    ...
    public init(from decoder: Decoder) throws {
        ...
        if depth > DecodingConfiguration.standard.threshold {
            if DecodingConfiguration.standard.debugMode {
                print("🔄 Deferring deep decode for MessageViewEmbedUnion at depth \(depth), type: \(typeValue)")
            }
    ...
    public mutating func loadPendingData() async {
        ...
        case .pending(let pendingData):
            do {
                ...
                if DecodingConfiguration.standard.debugMode {
                    print("❌ Failed to decode pending data for MessageViewEmbedUnion: \(error)")
                }
...
public indirect enum ConvoViewLastMessageUnion: Codable, ATProtocolCodable, ATProtocolValue, Sendable, Equatable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        if depth > DecodingConfiguration.standard.threshold {
            if DecodingConfiguration.standard.debugMode {
                print("🔄 Deferring deep decode for ConvoViewLastMessageUnion at depth \(depth), type: \(typeValue)")
            }
    ...
    public mutating func loadPendingData() async {
        ...
        case .pending(let pendingData):
            do {
                ...
                case "chat.bsky.convo.defs#messageView":
                    let value = try await SafeDecoder.decode(
                        ChatBskyConvoDefs.MessageView.self,
                        from: pendingData.rawData
                    )
                    self = .chatBskyConvoDefsMessageView(value)
                case "chat.bsky.convo.defs#deletedMessageView":
                    let value = try await SafeDecoder.decode(
                        ChatBskyConvoDefs.DeletedMessageView.self,
                        from: pendingData.rawData
                    )
                    self = .chatBskyConvoDefsDeletedMessageView(value)
                default:
                ...
                if DecodingConfiguration.standard.debugMode {
                    print("❌ Failed to decode pending data for ConvoViewLastMessageUnion: \(error)")
                }
                self = .unexpected(ATProtocolValueContainer.string("Failed to decode: \(error)"))
            }
...
public indirect enum LogCreateMessageMessageUnion: Codable, ATProtocolCodable, ATProtocolValue, Sendable, Equatable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        if depth > DecodingConfiguration.standard.threshold {
            if DecodingConfiguration.standard.debugMode {
                print("🔄 Deferring deep decode for LogCreateMessageMessageUnion at depth \(depth), type: \(typeValue)")
            }
    ...
    public mutating func loadPendingData() async {
        ...
        case .pending(let pendingData):
            do {
                ...
                if DecodingConfiguration.standard.debugMode {
                    print("❌ Failed to decode pending data for LogCreateMessageMessageUnion: \(error)")
                }
                self = .unexpected(ATProtocolValueContainer.string("Failed to decode: \(error)"))
            }
...
public indirect enum LogDeleteMessageMessageUnion: Codable, ATProtocolCodable, ATProtocolValue, Sendable, Equatable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        if depth > DecodingConfiguration.standard.threshold {
            if DecodingConfiguration.standard.debugMode {
                print("🔄 Deferring deep decode for LogDeleteMessageMessageUnion at depth \(depth), type: \(typeValue)")
            }
    ...
    public mutating func loadPendingData() async {
        ...
        case .pending(let pendingData):
            do {
                ...
                if DecodingConfiguration.standard.debugMode {
                    print("❌ Failed to decode pending data for LogDeleteMessageMessageUnion: \(error)")
                }
                self = .unexpected(ATProtocolValueContainer.string("Failed to decode: \(error)"))
            }
...
public indirect enum LogReadMessageMessageUnion: Codable, ATProtocolCodable, ATProtocolValue, Sendable, Equatable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        if depth > DecodingConfiguration.standard.threshold {
            if DecodingConfiguration.standard.debugMode {
                print("🔄 Deferring deep decode for LogReadMessageMessageUnion at depth \(depth), type: \(typeValue)")
            }
    ...
    public mutating func loadPendingData() async {
        ...
        case .pending(let pendingData):
            do {
                ...
                if DecodingConfiguration.standard.debugMode {
                    print("❌ Failed to decode pending data for LogReadMessageMessageUnion: \(error)")
                }
                self = .unexpected(ATProtocolValueContainer.string("Failed to decode: \(error)"))
            }
...
public indirect enum LogAddReactionMessageUnion: Codable, ATProtocolCodable, ATProtocolValue, Sendable, Equatable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        if depth > DecodingConfiguration.standard.threshold {
            if DecodingConfiguration.standard.debugMode {
                print("🔄 Deferring deep decode for LogAddReactionMessageUnion at depth \(depth), type: \(typeValue)")
            }
    ...
    public mutating func loadPendingData() async {
        ...
        case .pending(let pendingData):
            do {
                ...
                if DecodingConfiguration.standard.debugMode {
                    print("❌ Failed to decode pending data for LogAddReactionMessageUnion: \(error)")
                }
                self = .unexpected(ATProtocolValueContainer.string("Failed to decode: \(error)"))
            }
...
public indirect enum LogRemoveReactionMessageUnion: Codable, ATProtocolCodable, ATProtocolValue, Sendable, Equatable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        if depth > DecodingConfiguration.standard.threshold {
            if DecodingConfiguration.standard.debugMode {
                print("🔄 Deferring deep decode for LogRemoveReactionMessageUnion at depth \(depth), type: \(typeValue)")
            }
    ...
    public mutating func loadPendingData() async {
        ...
        case .pending(let pendingData):
            do {
                ...
                if DecodingConfiguration.standard.debugMode {
                    print("❌ Failed to decode pending data for LogRemoveReactionMessageUnion: \(error)")
                }
                self = .unexpected(ATProtocolValueContainer.string("Failed to decode: \(error)"))
            }
