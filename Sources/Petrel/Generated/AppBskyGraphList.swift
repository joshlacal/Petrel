...
public struct AppBskyGraphList: ATProtocolCodable, ATProtocolValue {
    ...
    public enum AppBskyGraphListLabelsUnion: Codable, ATProtocolCodable, ATProtocolValue {
        ...
        public init(from decoder: Decoder) throws {
            ...
            LogManager.logDebug("AppBskyGraphListLabelsUnion decoding: \(typeValue)")
            ...
            default:
                LogManager.logDebug("AppBskyGraphListLabelsUnion decoding encountered an unexpected type: \(typeValue)")
        ...
        public func encode(to encoder: Encoder) throws {
            ...
            case let .unexpected(ATProtocolValueContainer):
                LogManager.logDebug("AppBskyGraphListLabelsUnion encoding unexpected value")
