    ...
    public init(from decoder: Decoder) throws {
        ...
        if depth > DecodingConfiguration.standard.threshold {
            if DecodingConfiguration.standard.debugMode {
                print("🔄 Deferring deep decode for PostViewEmbedUnion at depth \(depth), type: \(typeValue)")
            }
    ...
    public mutating func loadPendingData() async {
        ...
        case .pending(let pendingData):
            do {
                ...
                if DecodingConfiguration.standard.debugMode {
                    print("❌ Failed to decode pending data for PostViewEmbedUnion: \(error)")
                }
...
public indirect enum ReplyRefRootUnion: Codable, ATProtocolCodable, ATProtocolValue, Sendable, Equatable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        if depth > DecodingConfiguration.standard.threshold {
            if DecodingConfiguration.standard.debugMode {
                print("🔄 Deferring deep decode for ReplyRefRootUnion at depth \(depth), type: \(typeValue)")
            }
    ...
    public mutating func loadPendingData() async {
        ...
        case .pending(let pendingData):
            do {
                ...
                if DecodingConfiguration.standard.debugMode {
                    print("❌ Failed to decode pending data for ReplyRefRootUnion: \(error)")
                }
                self = .unexpected(ATProtocolValueContainer.string("Failed to decode: \(error)"))
            }
...
public indirect enum ReplyRefParentUnion: Codable, ATProtocolCodable, ATProtocolValue, Sendable, Equatable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        if depth > DecodingConfiguration.standard.threshold {
            if DecodingConfiguration.standard.debugMode {
                print("🔄 Deferring deep decode for ReplyRefParentUnion at depth \(depth), type: \(typeValue)")
            }
    ...
    public mutating func loadPendingData() async {
        ...
        case .pending(let pendingData):
            do {
                ...
                if DecodingConfiguration.standard.debugMode {
                    print("❌ Failed to decode pending data for ReplyRefParentUnion: \(error)")
                }
                self = .unexpected(ATProtocolValueContainer.string("Failed to decode: \(error)"))
            }
