...
public struct AppBskyFeedDefs {
    ...
    public enum PostViewEmbedUnion: Codable, ATProtocolCodable, ATProtocolValue {
        ...
        public init(from decoder: Decoder) throws {
            ...
            LogManager.logDebug("PostViewEmbedUnion decoding: \(typeValue)")

            switch typeValue {
            case "app.bsky.embed.images#view":
                LogManager.logDebug("Decoding as app.bsky.embed.images#view")
                let value = try AppBskyEmbedImages.View(from: decoder)
                self = .appBskyEmbedImagesView(value)
            case "app.bsky.embed.video#view":
                LogManager.logDebug("Decoding as app.bsky.embed.video#view")
                let value = try AppBskyEmbedVideo.View(from: decoder)
                self = .appBskyEmbedVideoView(value)
            case "app.bsky.embed.external#view":
                LogManager.logDebug("Decoding as app.bsky.embed.external#view")
            ...
            case "app.bsky.embed.recordWithMedia#view":
                LogManager.logDebug("Decoding as app.bsky.embed.recordWithMedia#view")
                let value = try AppBskyEmbedRecordWithMedia.View(from: decoder)
                self = .appBskyEmbedRecordWithMediaView(value)
            default:
                LogManager.logDebug("PostViewEmbedUnion decoding encountered an unexpected type: \(typeValue)")
        ...
        public func encode(to encoder: Encoder) throws {
            ...
            case let .appBskyEmbedRecordWithMediaView(value):
                LogManager.logDebug("Encoding app.bsky.embed.recordWithMedia#view")
                try container.encode("app.bsky.embed.recordWithMedia#view", forKey: .type)
                try value.encode(to: encoder)
            case let .unexpected(ATProtocolValueContainer):
                LogManager.logDebug("PostViewEmbedUnion encoding unexpected value")
    ...
    public enum FeedViewPostReasonUnion: Codable, ATProtocolCodable, ATProtocolValue {
        ...
        public init(from decoder: Decoder) throws {
            let container = try decoder.container(keyedBy: CodingKeys.self)
            let typeValue = try container.decode(String.self, forKey: .type)
            LogManager.logDebug("FeedViewPostReasonUnion decoding: \(typeValue)")

            switch typeValue {
            case "app.bsky.feed.defs#reasonRepost":
                LogManager.logDebug("Decoding as app.bsky.feed.defs#reasonRepost")
                let value = try AppBskyFeedDefs.ReasonRepost(from: decoder)
                self = .appBskyFeedDefsReasonRepost(value)
            default:
                LogManager.logDebug("FeedViewPostReasonUnion decoding encountered an unexpected type: \(typeValue)")
                let unknownValue = try ATProtocolValueContainer(from: decoder)
                self = .unexpected(unknownValue)
            }
        }
        ...
        public func encode(to encoder: Encoder) throws {
            ...
            case let .appBskyFeedDefsReasonRepost(value):
                LogManager.logDebug("Encoding app.bsky.feed.defs#reasonRepost")
                try container.encode("app.bsky.feed.defs#reasonRepost", forKey: .type)
                try value.encode(to: encoder)
            case let .unexpected(ATProtocolValueContainer):
                LogManager.logDebug("FeedViewPostReasonUnion encoding unexpected value")
                try ATProtocolValueContainer.encode(to: encoder)
            }
        }
        ...
        public func isEqual(to other: any ATProtocolValue) -> Bool {
            ...
            switch (self, otherValue) {
            case let (.appBskyFeedDefsReasonRepost(selfValue),
    ...
    public enum ReplyRefRootUnion: Codable, ATProtocolCodable, ATProtocolValue {
        ...
        public init(from decoder: Decoder) throws {
            let container = try decoder.container(keyedBy: CodingKeys.self)
            let typeValue = try container.decode(String.self, forKey: .type)
            LogManager.logDebug("ReplyRefRootUnion decoding: \(typeValue)")

            switch typeValue {
            case "app.bsky.feed.defs#postView":
                LogManager.logDebug("Decoding as app.bsky.feed.defs#postView")
            ...
            default:
                LogManager.logDebug("ReplyRefRootUnion decoding encountered an unexpected type: \(typeValue)")
                let unknownValue = try ATProtocolValueContainer(from: decoder)
                self = .unexpected(unknownValue)
            }
        }
        ...
        public func encode(to encoder: Encoder) throws {
            ...
            case let .appBskyFeedDefsPostView(value):
                LogManager.logDebug("Encoding app.bsky.feed.defs#postView")
            ...
            case let .appBskyFeedDefsBlockedPost(value):
                ...
                try value.encode(to: encoder)
            case let .unexpected(ATProtocolValueContainer):
                LogManager.logDebug("ReplyRefRootUnion encoding unexpected value")
                try ATProtocolValueContainer.encode(to: encoder)
            }
        }
        ...
        public func isEqual(to other: any ATProtocolValue) -> Bool {
            ...
            switch (self, otherValue) {
            case let (.appBskyFeedDefsPostView(selfValue),
    ...
    public enum ReplyRefParentUnion: Codable, ATProtocolCodable, ATProtocolValue {
        ...
        public init(from decoder: Decoder) throws {
            let container = try decoder.container(keyedBy: CodingKeys.self)
            let typeValue = try container.decode(String.self, forKey: .type)
            LogManager.logDebug("ReplyRefParentUnion decoding: \(typeValue)")
            ...
            case "app.bsky.feed.defs#blockedPost":
                ...
                self = .appBskyFeedDefsBlockedPost(value)
            default:
                LogManager.logDebug("ReplyRefParentUnion decoding encountered an unexpected type: \(typeValue)")
                let unknownValue = try ATProtocolValueContainer(from: decoder)
                self = .unexpected(unknownValue)
            }
        }
        ...
        public func encode(to encoder: Encoder) throws {
            ...
            case let .appBskyFeedDefsBlockedPost(value):
                ...
                try value.encode(to: encoder)
            case let .unexpected(ATProtocolValueContainer):
                LogManager.logDebug("ReplyRefParentUnion encoding unexpected value")
                try ATProtocolValueContainer.encode(to: encoder)
            }
        }
    ...
    public indirect enum ThreadViewPostParentUnion: Codable, ATProtocolCodable, ATProtocolValue {
        ...
        public init(from decoder: Decoder) throws {
            let container = try decoder.container(keyedBy: CodingKeys.self)
            let typeValue = try container.decode(String.self, forKey: .type)
            LogManager.logDebug("ThreadViewPostParentUnion decoding: \(typeValue)")
            ...
            case "app.bsky.feed.defs#blockedPost":
                ...
                self = .appBskyFeedDefsBlockedPost(value)
            default:
                LogManager.logDebug("ThreadViewPostParentUnion decoding encountered an unexpected type: \(typeValue)")
                let unknownValue = try ATProtocolValueContainer(from: decoder)
                self = .unexpected(unknownValue)
            }
        }
        ...
        public func encode(to encoder: Encoder) throws {
            ...
            case let .appBskyFeedDefsBlockedPost(value):
                ...
                try value.encode(to: encoder)
            case let .unexpected(ATProtocolValueContainer):
                LogManager.logDebug("ThreadViewPostParentUnion encoding unexpected value")
                try ATProtocolValueContainer.encode(to: encoder)
            }
        }
    ...
    public indirect enum ThreadViewPostRepliesUnion: Codable, ATProtocolCodable, ATProtocolValue {
        ...
        public init(from decoder: Decoder) throws {
            let container = try decoder.container(keyedBy: CodingKeys.self)
            let typeValue = try container.decode(String.self, forKey: .type)
            LogManager.logDebug("ThreadViewPostRepliesUnion decoding: \(typeValue)")
            ...
            case "app.bsky.feed.defs#blockedPost":
                ...
                self = .appBskyFeedDefsBlockedPost(value)
            default:
                LogManager.logDebug("ThreadViewPostRepliesUnion decoding encountered an unexpected type: \(typeValue)")
                let unknownValue = try ATProtocolValueContainer(from: decoder)
                self = .unexpected(unknownValue)
            }
        }
        ...
        public func encode(to encoder: Encoder) throws {
            ...
            case let .appBskyFeedDefsBlockedPost(value):
                ...
                try value.encode(to: encoder)
            case let .unexpected(ATProtocolValueContainer):
                LogManager.logDebug("ThreadViewPostRepliesUnion encoding unexpected value")
                try ATProtocolValueContainer.encode(to: encoder)
            }
        }
    ...
    public enum SkeletonFeedPostReasonUnion: Codable, ATProtocolCodable, ATProtocolValue {
        ...
        public init(from decoder: Decoder) throws {
            let container = try decoder.container(keyedBy: CodingKeys.self)
            let typeValue = try container.decode(String.self, forKey: .type)
            LogManager.logDebug("SkeletonFeedPostReasonUnion decoding: \(typeValue)")

            switch typeValue {
            case "app.bsky.feed.defs#skeletonReasonRepost":
                LogManager.logDebug("Decoding as app.bsky.feed.defs#skeletonReasonRepost")
                let value = try AppBskyFeedDefs.SkeletonReasonRepost(from: decoder)
                self = .appBskyFeedDefsSkeletonReasonRepost(value)
            default:
                LogManager.logDebug("SkeletonFeedPostReasonUnion decoding encountered an unexpected type: \(typeValue)")
                let unknownValue = try ATProtocolValueContainer(from: decoder)
                self = .unexpected(unknownValue)
            }
        }
        ...
        public func encode(to encoder: Encoder) throws {
            ...
            case let .appBskyFeedDefsSkeletonReasonRepost(value):
                LogManager.logDebug("Encoding app.bsky.feed.defs#skeletonReasonRepost")
                try container.encode("app.bsky.feed.defs#skeletonReasonRepost", forKey: .type)
                try value.encode(to: encoder)
            case let .unexpected(ATProtocolValueContainer):
                LogManager.logDebug("SkeletonFeedPostReasonUnion encoding unexpected value")
                try ATProtocolValueContainer.encode(to: encoder)
            }
        }
        ...
        public func isEqual(to other: any ATProtocolValue) -> Bool {
            ...
            switch (self, otherValue) {
            case let (.appBskyFeedDefsSkeletonReasonRepost(selfValue),
