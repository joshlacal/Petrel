...
public enum ToolsOzoneModerationGetSubjects {
    ...
    public struct Output: ATProtocolCodable {
        ...
        public init(from decoder: Decoder) throws {
            ...
            subjects = try container.decode([ToolsOzoneModerationDefs.SubjectView].self, forKey: .subjects)
        }
...
public extension ATProtoClient.Tools.Ozone.Moderation {
    ...
    func getSubjects(input: ToolsOzoneModerationGetSubjects.Parameters) async throws -> (responseCode: Int, data: ToolsOzoneModerationGetSubjects.Output?) {
