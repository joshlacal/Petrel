...
extension ATProtoClient.App.Bsky.Feed {
    ...
    public func getFeed(input: AppBskyFeedGetFeed.Parameters) async throws -> (responseCode: Int, data: AppBskyFeedGetFeed.Output?) {
        ...
        let serviceDID = await networkService.getServiceDID(for: "app.bsky.feed.getFeed")
        ...
        if (200...299).contains(responseCode) {
            do {
                ...
                LogManager.logError("Failed to decode successful response for app.bsky.feed.getFeed: \(error)")
            ...
            if let atprotoError = ATProtoErrorParser.parse(
                ...
                errorType: AppBskyFeedGetFeed.Error.self
            ) {
                throw atprotoError
            }
