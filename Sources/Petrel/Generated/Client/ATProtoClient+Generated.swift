...
public actor ATProtoClient {
    ...
    public var app: App { App(networkService: networkService) }
...
public struct App: Sendable {
    ...
    public var bsky: Bsky { Bsky(networkService: networkService) }
    ...
    public struct Bsky: Sendable {
        ...
        public var authCreatePosts: AuthCreatePosts { AuthCreatePosts(networkService: networkService) }

        @available(*, deprecated, renamed: "authCreatePosts")
        public var authcreateposts: AuthCreatePosts { authCreatePosts }
        ...
        public var authDeleteContent: AuthDeleteContent { AuthDeleteContent(networkService: networkService) }

        @available(*, deprecated, renamed: "authDeleteContent")
        public var authdeletecontent: AuthDeleteContent { authDeleteContent }
        ...
        public var authFullApp: AuthFullApp { AuthFullApp(networkService: networkService) }

        @available(*, deprecated, renamed: "authFullApp")
        public var authfullapp: AuthFullApp { authFullApp }
        ...
        public var authManageFeedDeclarations: AuthManageFeedDeclarations { AuthManageFeedDeclarations(networkService: networkService) }

        @available(*, deprecated, renamed: "authManageFeedDeclarations")
        public var authmanagefeeddeclarations: AuthManageFeedDeclarations { authManageFeedDeclarations }
        ...
        public var authManageLabelerService: AuthManageLabelerService { AuthManageLabelerService(networkService: networkService) }

        @available(*, deprecated, renamed: "authManageLabelerService")
        public var authmanagelabelerservice: AuthManageLabelerService { authManageLabelerService }
        ...
        public var authManageModeration: AuthManageModeration { AuthManageModeration(networkService: networkService) }

        @available(*, deprecated, renamed: "authManageModeration")
        public var authmanagemoderation: AuthManageModeration { authManageModeration }
        ...
        public var authManageNotifications: AuthManageNotifications { AuthManageNotifications(networkService: networkService) }

        @available(*, deprecated, renamed: "authManageNotifications")
        public var authmanagenotifications: AuthManageNotifications { authManageNotifications }
        ...
        public var authManageProfile: AuthManageProfile { AuthManageProfile(networkService: networkService) }

        @available(*, deprecated, renamed: "authManageProfile")
        public var authmanageprofile: AuthManageProfile { authManageProfile }
        ...
        public var authViewAll: AuthViewAll { AuthViewAll(networkService: networkService) }

        @available(*, deprecated, renamed: "authViewAll")
        public var authviewall: AuthViewAll { authViewAll }
        ...
        public var actor: Actor { Actor(networkService: networkService) }
        ...
        public var ageassurance: Ageassurance { Ageassurance(networkService: networkService) }
        ...
        public var bookmark: Bookmark { Bookmark(networkService: networkService) }
        ...
        public var contact: Contact { Contact(networkService: networkService) }
        ...
        public var draft: Draft { Draft(networkService: networkService) }
        ...
        public var embed: Embed { Embed(networkService: networkService) }
        ...
        public var feed: Feed { Feed(networkService: networkService) }
        ...
        public var labeler: Labeler { Labeler(networkService: networkService) }
        ...
        public var notification: Notification { Notification(networkService: networkService) }
        ...
        public var unspecced: Unspecced { Unspecced(networkService: networkService) }
...
public struct Chat: Sendable {
    ...
    public struct Bsky: Sendable {
        ...
        public var authFullChatClient: AuthFullChatClient { AuthFullChatClient(networkService: networkService) }

        @available(*, deprecated, renamed: "authFullChatClient")
        public var authfullchatclient: AuthFullChatClient { authFullChatClient }
        ...
        public var convo: Convo { Convo(networkService: networkService) }
        ...
        public var group: Group { Group(networkService: networkService) }
...
public var com: Com { Com(networkService: networkService) }
...
public struct Com: Sendable {
    ...
    public var atproto: Atproto { Atproto(networkService: networkService) }
    ...
    public struct Atproto: Sendable {
        ...
        public var admin: Admin { Admin(networkService: networkService) }
        ...
        public var identity: Identity { Identity(networkService: networkService) }
        ...
        public var label: Label { Label(networkService: networkService) }
        ...
        public var lexicon: Lexicon { Lexicon(networkService: networkService) }
        ...
        public var repo: Repo { Repo(networkService: networkService) }
        ...
        public var simplespace: Simplespace { Simplespace(networkService: networkService) }
        ...
        public var space: Space { Space(networkService: networkService) }
        ...
        public var sync: Sync { Sync(networkService: networkService) }
        ...
        public var temp: Temp { Temp(networkService: networkService) }
    ...
    public var germnetwork: Germnetwork { Germnetwork(networkService: networkService) }
    ...
    public struct Germnetwork: Sendable {
        ...
        public var declaration: Declaration { Declaration(networkService: networkService) }
...
public var site: Site { Site(networkService: networkService) }
...
public struct Site: Sendable {
    ...
    public var standard: Standard { Standard(networkService: networkService) }
    ...
    public struct Standard: Sendable {
        ...
        public var document: Document { Document(networkService: networkService) }
        ...
        public var publication: Publication { Publication(networkService: networkService) }
        ...
        public var theme: Theme { Theme(networkService: networkService) }
