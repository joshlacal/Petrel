...
public enum Error: String, Swift.Error, ATProtoErrorType, CustomStringConvertible {
                ...
                case invalidWelcome = "InvalidWelcome"
                ...
                case keyPackageAlreadyConsumed = "KeyPackageAlreadyConsumed"
                /// Referenced key package is reserved by another Welcome message
                case keyPackageReserved = "KeyPackageReserved"
                /// Welcome message is not for the authenticated user
                case recipientMismatch = "RecipientMismatch"
    ...
    public func validateWelcome(
        ...
        if (200...299).contains(responseCode) {
            ...
            if let atprotoError = ATProtoErrorParser.parse(
                ...
                errorType: BlueCatbirdMlsValidateWelcome.Error.self
            ) {
                throw atprotoError
            }
