...
public struct GapInfo: ATProtocolCodable, ATProtocolValue {
        ...
        public func isEqual(to other: any ATProtocolValue) -> Bool {
            ...
            if self.missingSeqs != other.missingSeqs {
                return false
            }
            ...
            if self.totalMessages != other.totalMessages {
                return false
            }
    ...
    public func getMessages(input: BlueCatbirdMlsGetMessages.Parameters) async throws -> (responseCode: Int, data: BlueCatbirdMlsGetMessages.Output?) {
        ...
        if (200...299).contains(responseCode) {
            ...
            if let atprotoError = ATProtoErrorParser.parse(
                ...
                errorType: BlueCatbirdMlsGetMessages.Error.self
            ) {
                throw atprotoError
            }
