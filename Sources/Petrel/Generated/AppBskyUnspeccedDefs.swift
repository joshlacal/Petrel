...
public struct AgeAssuranceState: ATProtocolCodable, ATProtocolValue {
        ...
        public init(from decoder: Decoder) throws {
            ...
            do {
                ...
                LogManager.logError("Decoding error for property 'lastInitiatedAt': \(error)")
                throw error
            }
            do {
...
public struct AgeAssuranceEvent: ATProtocolCodable, ATProtocolValue {
        ...
        public init(from decoder: Decoder) throws {
            ...
            do {
                ...
                LogManager.logError("Decoding error for property 'attemptId': \(error)")
                throw error
            }
            do {
            ...
            do {
                ...
                LogManager.logError("Decoding error for property 'initIp': \(error)")
                throw error
            }
            do {
                ...
                LogManager.logError("Decoding error for property 'initUa': \(error)")
                throw error
            }
            do {
                ...
                LogManager.logError("Decoding error for property 'completeIp': \(error)")
                throw error
            }
            do {
                ...
                LogManager.logError("Decoding error for property 'completeUa': \(error)")
                throw error
            }
