...
extension ATProtoClient.App.Bsky.Graph {
    ...
    public func getKnownFollowers(input: AppBskyGraphGetKnownFollowers.Parameters) async throws -> (responseCode: Int, data: AppBskyGraphGetKnownFollowers.Output?) {
        ...
        let serviceDID = await networkService.getServiceDID(for: "app.bsky.graph.getKnownFollowers")
        ...
        if (200...299).contains(responseCode) {
            do {
                ...
                LogManager.logError("Failed to decode successful response for app.bsky.graph.getKnownFollowers: \(error)")
