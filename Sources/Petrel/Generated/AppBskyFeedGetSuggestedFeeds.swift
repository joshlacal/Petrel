...
extension ATProtoClient.App.Bsky.Feed {
    ...
    public func getSuggestedFeeds(input: AppBskyFeedGetSuggestedFeeds.Parameters) async throws -> (responseCode: Int, data: AppBskyFeedGetSuggestedFeeds.Output?) {
        ...
        let serviceDID = await networkService.getServiceDID(for: "app.bsky.feed.getSuggestedFeeds")
        ...
        if (200...299).contains(responseCode) {
            do {
                ...
                LogManager.logError("Failed to decode successful response for app.bsky.feed.getSuggestedFeeds: \(error)")
