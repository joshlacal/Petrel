...
extension ATProtoClient.App.Bsky.Feed {
    ...
    public func getListFeed(input: AppBskyFeedGetListFeed.Parameters) async throws -> (responseCode: Int, data: AppBskyFeedGetListFeed.Output?) {
        ...
        let serviceDID = await networkService.getServiceDID(for: "app.bsky.feed.getListFeed")
        ...
        if (200...299).contains(responseCode) {
            do {
                ...
                LogManager.logError("Failed to decode successful response for app.bsky.feed.getListFeed: \(error)")
            ...
            if let atprotoError = ATProtoErrorParser.parse(
                ...
                errorType: AppBskyFeedGetListFeed.Error.self
            ) {
                throw atprotoError
            }
