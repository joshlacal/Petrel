...
public actor TokenManager: TokenManaging {
  ...
  static func clearLastActiveDID(namespace: String) async {
    ...
    LogManager.logError("TOKEN_MANAGER: About to delete key: \(namespacedKey)")
    ...
    do {
      ...
      LogManager.logError(
        "TOKEN_MANAGER: KeychainManager.delete FAILED for key \(keyToDelete): \(error)")
    }
  }
}
