...
actor TokenRefreshCoordinator {
  ...
  enum RefreshError: Error, LocalizedError {
    ...
    var errorDescription: String? {
      ...
      case .refreshFunctionError(let underlying):
  ...
  private func completeRefresh(for completedTask: Task<RefreshResult, Error>) async {
    ...
    guard self.refreshTask == completedTask else {
      LogManager.logDebug(
    ...
    let continuationsToResume = self.waitingContinuations
